...
<div class="Inner-banner">
    <div class="container">
        <div class="row">
            <!--  SLIDER IMAGE -->
            <div class="col-lg-5 col-md-5 col-sm-12 col-xs-12 inner-page-text"> <h2>Thin App List</h2> </div>
        ...
        <div class="container">
            <div class="row">
                <div class="middle-block">
                    ...
                    <?php }else{ ?>
                        <div class="col-lg-10 col-md-10 col-sm-10 col-xs-10 col-sm-offset-1" style="padding: 0;">
                    ...
                    <?php } ?>
                       <div class="Social-login-box payment_bx">
                            ...
                            <?php echo $this->Form->create('Search',array('type'=>'get','url'=>array('controller'=>'supp','action' => 'search_thinapp_list'),'admin'=>true)); ?>
                            <div class="form-group">
                                ...
                                <div class="col-sm-2">
                                    <?php echo $this->Form->label('&nbsp;'); ?>
                                    <div class="submit">
                                        <a href="<?php echo $this->Html->url(array('controller'=>'supp','action'=>'thinapp_list')) ?>"><button type="button" class="Btn-typ3" >Reset</button></a>
                                    </div>
                                </div>
                        ...
                        <div class="table-responsive">
                            <table class="table table-responsive ">
                                ...
                                <tr >
                                    ...
                                    <th width="120">Allowed Doctor Count</th>

                                    <?php } ?>
                                    <th width="120">Lead Staus</th>
                                ...
                                if(isset($data) && !empty($data))
                                {
                                    foreach($data as $key => $val)
                                    {
                                        ...
                                        <tr>
                                            ...
                                            <!--<td><?php /* echo $val['Thinapp']['app_id']; */?></td>-->
                                            <td>
                                            ...
                                            <td><?php  echo $val['Thinapp']['id']; ?></td>
                                            <td>
                                                <?php echo $val['Thinapp']['name']; ?>
                                            <div style="display: none;" class="setting_end_date_<?php echo $val['Thinapp']['id']; ?>"><?php echo date('d-M-Y',strtotime($val['Thinapp']['end_date'])); ?></div>
                                            </td>
                                        <?php if($this->SupportAdmin->isMainSupportAdmin()){ ?>
                                            <td><?php echo $val['Thinapp']['phone']; ?></td>
                                            <td><?php echo empty($val['User']['verification_code'])?'N/A':$val['User']['verification_code']; ?></td>
                                            <td><?php echo $this->Form->input('category',array("row-id"=> $val['Thinapp']['id'],'type'=>'select','label'=>false,'options'=>array('DOCTOR'=>'Doctor','HOSPITAL'=>'Hospital'),'default'=>$val['Thinapp']['category_name'],'class'=>'category_status')); ?></td>
                                            <td><input row-thinapp-id="<?php echo $val['Thinapp']['id']; ?>" type ="text" style="width: 100%;padding: 0px 6px; height: 23px;" class="form-control doctor_count" last-value = "<?php echo $val['Thinapp']['allowed_doctor_count']; ?>" value = "<?php echo $val['Thinapp']['allowed_doctor_count']; ?>" ></td>
                                        <?php } ?>
                                            <td><?php echo $this->Form->input('status',array("row-id"=> $val['Leads']['customer_id'],'type'=>'select','label'=>false,'options'=>array('NEW'=>'New','INPROCESS'=>'Inprocess','REJECTED'=>'Rejected','DONE'=>'Done'),'default'=>$val['Leads']['status'],'class'=>'lead_status')); ?></td>
                                            <td><input row-id="<?php echo $val['Thinapp']['id']; ?>" type ="text" style="width: 100%;padding: 0px 6px; height: 23px;" class="form-control version_name" last-value = "<?php echo $val['Thinapp']['version_name']; ?>" value = "<?php echo $val['Thinapp']['version_name']; ?>" ></td>
                                            <td class="td_links">
                                                <div style="display:flex;">


                                                    <button style="display: <?php echo ($val['Thinapp']['is_published']=='YES')?'block':'none'; ?>" type="button" id="changeStatus" class="action_icon btn btn-primary btn-xs setting_div_<?php echo $val['Thinapp']['id']; ?>" row-id="<?php echo $val['Thinapp']['id']; ?>" ><?php echo $val['Thinapp']['status']; ?></button>
                                                    &nbsp;<button style="display: <?php echo ($val['Thinapp']['is_published']=='YES')?'block':'none'; ?>" type="button" id="view" class="action_icon btn btn-primary btn-xs setting_div_<?php echo $val['Thinapp']['id']; ?>"  row-id="<?php echo $val['Thinapp']['id']; ?>" ><i class="fa fa-eye"></i></button>

                                                    &nbsp;
                                                    <!--&nbsp;<button style="display: <?php /*echo ($val['Thinapp']['is_published']=='YES')?'block':'none'; */?>" type="button" id="edit" class="action_icon btn btn-primary btn-xs setting_div_<?php /*echo $val['Thinapp']['id']; */?>"  row-id="<?php /*echo $val['Thinapp']['id']; */?>" ><i class="fa fa-edit"></i></button>
-->

                                                    <button style="display: <?php echo ($val['Thinapp']['is_published']=='YES')?'block':'none'; ?>" title="Add permission to this app" type="button"  class="user_permission action_icon btn btn-primary btn-xs setting_div_<?php echo $val['Thinapp']['id']; ?>"  row-id="<?php echo $val['Thinapp']['id']; ?>" ><i class="fa fa-user"></i></button>

                                                    <?php if($this->AppAdmin->check_app_enable_permission($val['Thinapp']['id'],"SMART_CLINIC")){ ?>
                                                        <button  style="display: block;margin-left: 5px; padding: 0px 5px;" title="Booking Conveince Fee Modal Setting" type="button"  class="convence_btn action_icon btn btn-warning btn-xs>"  row-id="<?php echo $val['Thinapp']['id']; ?>" ><i class="fa fa-inr"></i></button>
                                                    <?php } ?>
                                        ...
                                        <tr class="link_tr">
                                             ...
                                             <td></td>
                                            <td colspan="3">
                                                <div style="width: 100%;padding: 4px; margin-top: -32px; text-align: left" class="shor_link">

                                                    <?php
                                                            $url = str_replace(array("http://","https://"),array("",""),$val['Thinapp']['apk_url']) ;
                                                            $url = "https://$url";
                                                    ?>
                                                    Apk Url:- <a href="<?php echo $url; ?>" target="_blank"><?php echo $url; ?></a>
                                                </div>
                                            </td>
                                            <td colspan="4">
                                                <div style="width: 100%;padding: 4px; margin-top: -32px; text-align: right" class="shor_link">
                                                    Web Booking Url:- <a href="<?php echo $val['Thinapp']['web_booking_url']; ?>" target="_blank"><?php echo $val['Thinapp']['web_booking_url']; ?></a>
                                                </div>
                                            </td>
                                        </tr>
