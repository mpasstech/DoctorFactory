                ...
                <div class="middle-block">
                    ...
                    <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
                        ...
                        <div class="progress-bar channel_tap">
                            ...
                            <a id="v_app_channel_list" href="<?php echo Router::url('/admin/supp/sell'); ?>"><i class="fa fa-list"></i> Sell Item List</a>
                            <a id="v_add_channel" class='active' href="<?php echo Router::url('/admin/supp/permit_sell'); ?>" ><i class="fa fa-globe"></i> Permit Sell Item</a>
                        ...
                        <div class="Social-login-box payment_bx">
                            <?php echo $this->Form->create('Search',array('type'=>'get','url'=>array('controller'=>'supp','action' => 'search_permit_sell'),'admin'=>true)); ?>
                            <div class="form-group">
                                ...
                                <div class="col-sm-2">
                                    <?php echo $this->Form->label('&nbsp;'); ?>
                                    <div class="submit">
                                        <a href="<?php echo $this->Html->url(array('controller'=>'supp','action'=>'permit_sell')) ?>"><button type="button" class="Btn-typ3" >Reset</button></a>
                                    </div>
                                </div>
                            </div>
                            <div class="clear"></div>
                                                    ...
                                                    <table class="table">
                                                        ...
                                                        foreach ($sellItems as $key => $value){
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <a href="<?php echo $this->Html->url(array('controller'=>'supp','action'=>'permit_sell_images',base64_encode($value['SellItem']['id']))) ?>" >
...
<script>
    $(document).ready(function(){
        ...
        $(document).on('click','#changeSellPermission',function(e){
            ...
            var thisButton = $(this);
            $.ajax({
                url: baseurl+'/admin/supp/change_sell_mbroadcast_publish_status',
                data:{sellID:sellID},
                type:'POST',
                beforeSend:function(){
                    $(thisButton).button('loading').html('<i class="fa fa-spinner fa-pulse fa-2x fa-fw">');
