...
<?php  echo $this->Html->script(array('dataTableBundle.js','jquery.maskedinput-1.2.2-co.min.js','comman.js','bootstrap-toggle.min.js','bootstrap-confirmation.js')); ?>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="middle-block">
                    ...
                    <h3 class="screen_title" style="margin-bottom: -10px;">Cashfree Refund Panel</h3>
                    <div class="col-lg-12 right_box_div">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 search_row">
                            ...
                            <div class="form-group" style="margin-bottom: 0;">
                                ...
                                <div class="col-md-2">
                                    <?php echo $this->Form->input('thinapp_id', array('id'=>'thinapp_id','type' => 'select','options'=>$thinAppList,'label' => 'Thinapp', 'class' => 'form-control')); ?>
                                </div>
                            ...
                            <div class="form-group">
                                <div class="col-sm-6 action_btn" >
                                    <div class="input text">
                                        ...
                                        <a class="btn btn-warning" href="<?php echo $this->Html->url(array('controller'=>'supp','action'=>'refund_convenience_fee')) ?>">Reset</a>
    ...
    $(document).ready(function () {
        ...
        $(document).on("submit","#search_form",function (e) {
            ...
            if(in_process===false){
                ...
                $.ajax({
                    type:'POST',
                    url: baseurl+"admin/supp/search_convenience_appointment",
                    data:$(this).serialize(),
                    beforeSend:function(){
                        in_process=true;
        ...
        $(".date_from, .date_to").datepicker({clearBtn:true,format: 'dd/mm/yyyy' ,autoclose:true,orientation: "bottom auto"});
