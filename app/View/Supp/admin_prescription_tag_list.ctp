...
<div class="Inner-banner">
    <div class="container">
        <div class="row">
            <!--  SLIDER IMAGE -->
            <div class="col-lg-5 col-md-5 col-sm-12 col-xs-12 inner-page-text"> <h2>Prescription Tag List</h2> </div>
            ...
            <div class="row">
                ...
                <div class="middle-block">
                    ...
                    <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
                        <?php echo $this->element('support_prescription_tab'); ?>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="action_icon">
                                                <?php
                                                echo $this->Html->link('',Router::url('/admin/supp/edit_prescription_tag/',true).base64_encode($list['PrescriptionTag']['id']),
                                            ...
                                            <div class="action_icon">
                                                ...
                                                echo $this->Html->link('','javascript:void(0);',
                                                    array('data'=>Router::url('/admin/supp/delete_prescription_tag/',true).base64_encode($list['PrescriptionTag']['id']),'class' => 'fa fa-trash delete_cms', 'title' => 'Delete this Tip.'));
