                ...
                <div class="middle-block">
                    ...
                    <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
                        ...
                        <div class="progress-bar channel_tap">
                            ...
                            <a id="v_add_channel" href="<?php echo Router::url('/admin/supp/add_buy'); ?>" ><i class="fa fa-television"></i> Add Buy, Borrow & Rent</a>

                            <a id="v_add_channel" class='active' href="<?php echo Router::url('/admin/supp/permit_buy'); ?>" ><i class="fa fa-globe"></i> Permit Buy, Borrow & Rent</a>
                        ...
                        <div class="Social-login-box payment_bx">
                            <?php echo $this->Form->create('Search',array('type'=>'get','url'=>array('controller'=>'supp','action' => 'search_permit_buy'),'admin'=>true)); ?>
                            <div class="form-group">
                                ...
                                <div class="col-sm-2">
                                    <?php echo $this->Form->label('&nbsp;'); ?>
                                    <div class="submit">
                                        <a href="<?php echo $this->Html->url(array('controller'=>'supp','action'=>'permit_buy')) ?>"><button type="button" class="Btn-typ3" >Reset</button></a>
                                    </div>
                                </div>
                            </div>
                            <div class="clear"></div>
...
<script>
    $(document).ready(function(){
        $(document).on('click','#changeQuestStatus',function(e){
            ...
            var thisButton = $(this);
            $.ajax({
                url: baseurl+'/admin/supp/change_buy_status',
        ...
        $(document).on('click','#viewQuest',function () {
            ...
            var thisButton = $(this);
            $.ajax({
                url: baseurl+'/admin/supp/view_buy',
                data:{questID:questID},
                type:'POST',
                beforeSend:function(){
                    $(thisButton).button('loading').html('<i class="fa fa-spinner fa-pulse fa-2x fa-fw">');
        ...
        $(document).on('click','#viewQuestResponse',function () {
            ...
            var thisButton = $(this);
            $.ajax({
                url: baseurl+'/admin/supp/view_buy_result',
                data:{questID:questID},
                type:'POST',
                beforeSend:function(){
                    $(thisButton).button('loading').html('<i class="fa fa-spinner fa-pulse fa-2x fa-fw">');
        ...
        $(document).on('click','#changeQuestPermission',function(e){
            ...
            var thisButton = $(this);
            $.ajax({
                url: baseurl+'/admin/supp/change_buy_mbroadcast_publish_status',
                data:{questID:questID},
                type:'POST',
                beforeSend:function(){
                    $(thisButton).button('loading').html('<i class="fa fa-spinner fa-pulse fa-2x fa-fw">');
