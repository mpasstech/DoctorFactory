                   ...
                   <?php echo $this->element('support_admin_leftsidebar'); ?>
                    <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
                        <div class="progress-bar channel_tap">
                            ...
                            <a href="<?php echo Router::url('/admin/supp/gift_redeem_list'); ?>" class="active" ><i class="fa fa-list"></i> Redeem</a>
                        ...
                        <div class="Social-login-box payment_bx">
                            ...
                            <?php echo $this->Form->create('Search',array('type'=>'get','url'=>array('controller'=>'supp','action' => 'search_gift_redeem_list'),'admin'=>true)); ?>
                            <div class="form-group">
                                ...
                                <div class="col-sm-2">
                                    <?php echo $this->Form->label('&nbsp;'); ?>
                                    <div class="submit">
                                        <a href="<?php echo $this->Html->url(array('controller'=>'supp','action'=>'gift_redeem_list')) ?>"><button type="button" class="Btn-typ3" >Reset</button></a>
                                    </div>
                                </div>
                            </div>
                                ...
                                <table class="table">
									...
									foreach ($data as $key => $value){
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $value['RedeemGift']['type']; ?></td>
                                            <td><?php echo date('d-M-Y H:i:s',strtotime($value['RedeemGift']['created'])); ?></td>
                                            <td class="td_links">
                                                <div class="action_icon" style="display:flex;">
                                                    <button type="button" id="ViewGift" class="btn btn-primary btn-xs" row-id="<?php echo $value['RedeemGift']['id']; ?>" ><i class="fa fa-eye fa-2x"></i></button>
                                                    &nbsp;<button type="button" id="changeStatus" class="btn btn-primary btn-xs" row-id="<?php echo $value['RedeemGift']['id']; ?>" ><?php echo $value['RedeemGift']['status']; ?></button>
                                                </div>
                                            </td>
                                        </tr>
                                    <?php } ?>
    ...
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            ...
            <div class="modal-header">
                ...
                <h4 class="modal-title">View Redeem Gift</h4>
            </div>
...
<script>
    $(document).ready(function () {
            ...
            $(document).on('click','#changeStatus',function(e){
                ...
                var thisButton = $(this);
                $.ajax({
                    url: baseurl+'/admin/supp/change_gift_redeem_status',
                    data:{rowID:rowID},
                    type:'POST',
                    beforeSend:function(){
            ...
            $(document).on('click','#ViewGift',function(e){
                ...
                var thisButton = $(this);
                $.ajax({
                    url: baseurl+'/admin/supp/view_gift_redeem',
                    data:{rowID:rowID},
                    type:'POST',
                    beforeSend:function(){
                        $(thisButton).button('loading').html('<i class="fa fa-spinner fa-pulse fa-2x fa-fw">');
