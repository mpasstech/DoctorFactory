...
<div class="Inner-banner">
    <div class="container">
        <div class="row">
            <!--  SLIDER IMAGE -->
            <div class="col-lg-5 col-md-5 col-sm-12 col-xs-12 inner-page-text"> <h2>Child Milestone List</h2> </div>
            ...
            <div class="row">
                ...
                <div class="middle-block">
                    ...
                    <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
                        <?php echo $this->element('support_child_milestone_tab'); ?>
                        ...
                        <div class="Social-login-box payment_bx">
                            ...
                            <?php if(!empty($channel)){ ?>
                                <table class="table">
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $list['PrescriptionTag']['name']; ?></td>
                                        <td><?php echo $list['PrescriptionTag']['gender']; ?></td>
                                        <td><?php echo ($list['PrescriptionTag']['thinapp_id'] ==0)?"YES":"NO"; ?></td>

										<td><?php echo ucfirst($list['PrescriptionTag']['status']); ?></td>
                                        <td>
                                            <div class="action_icon">
                                                <?php
                                                echo $this->Html->link('',Router::url('/admin/supp/edit_child_milestone/',true).base64_encode($list['PrescriptionTag']['id']),
                                            ...
                                            <div class="action_icon">
                                                ...
                                                echo $this->Html->link('','javascript:void(0);',
                                                    array('data'=>Router::url('/admin/supp/delete_child_milestone/',true).base64_encode($list['PrescriptionTag']['id']),'class' => 'fa fa-trash delete_cms', 'title' => 'Delete this Tip.'));
                            ...
                            <?php }else{ ?>
                                <div class="no_data">
                                    <h2>You have no added child milestone</h2>
                                </div>
                            <?php } ?>
