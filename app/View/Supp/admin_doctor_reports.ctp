...
<div class="Inner-banner">
    <div class="container">
        <div class="row">
            <!--  SLIDER IMAGE -->
            <div class="col-lg-5 col-md-5 col-sm-12 col-xs-12 inner-page-text"> <h2>Doctor Reports</h2> </div>
                        ...
                        <div class="Social-login-box dashboard_box" style="padding: 15px; 20px;">
                            ...
                            <div class="form-group char_group">
                                ...
                                <div class="row row_master">
                                    ...
                                    <h3>Doctor Dashboard Stats Graph</h3>
...
<script type="text/javascript">
    $(function(){
        ...
        function load_bar_chart(){
                ...
                $.ajax({
                    type:'POST',
                    url: baseurl+"/admin/supp/doctor_report_graph",
