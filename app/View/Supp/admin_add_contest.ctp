<div class="Inner-banner">
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-5 col-md-5 col-sm-12 col-xs-12 inner-page-text"> <h2>Add Contest</h2> </div>
                        ...
                        <div class="Social-login-box payment_bx">
                            ...
                            <div class="form-group">
                                <div class="col-sm-12">
                                    ...
                                    <?php echo $this->Form->input('description',array('type'=>'textarea','id'=>'editor1','placeholder'=>'Description','label'=>false,'class'=>'form-control cnt','required'=>true)); ?>
                                </div>
                            </div>
                            ...
                            <!--div class="form-group" id="maxTime" style="display: none;">
                                <div class="col-sm-12">
                            ...
                            <div class="form-group">
                                <div class="col-sm-12">
                                    <label>Image</label>
                                    <?php echo $this->Form->input('image',array('type'=>'file','accept'=>'image/*','label'=>false,'class'=>'form-control cnt','required'=>true)); ?>
                                </div>
                            </div>

                            <div class="form-group">
                                <div class="col-sm-3 pull-right">
                                    <?php echo $this->Form->submit('Add Contest',array('class'=>'Btn-typ5','id'=>'addContest')); ?>
                                </div>
                            </div>
...
<script>
    ...
    $(document).on('change','#ContestAllowMaximumTimeLimit',function () {
        ...
        {
            $("#maxTime").hide();
            $("#ContestMaximumTimeLimit").attr("required",false);
        }
