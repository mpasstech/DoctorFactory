                        ...
                        <div class="Social-login-box dashboard_box" style="padding: 15px; 20px;">
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-4">
                                            <?php echo $this->Form->input('dwn_cnt', array('type' => 'text',  'label' => 'Download Count >= ', 'value'=>'100','class' => 'form-control dwn_cnt')); ?>
                                        </div>
                                        <div class="col-sm-4">
                                            <?php echo $this->Form->input('avg_cnt', array('type' => 'text',  'label' => 'Per Day Average >= ', 'value'=>'3', 'class' => 'form-control avg_cnt')); ?>
                                        </div>
                                        <div class="col-sm-2">
                            ...
                            <div class="form-group">
                                ...
                                <div class="row row_master">
                                    ...
                                    <h3 style="text-align: center;">Tiger Report</h3>
...
<script type="text/javascript">
    $(function(){
        ...
        function load_tiger_report(){
                ...
                $.ajax({
                    type:'POST',
                    url: baseurl+"/admin/supp/load_tiger_report",
                    data:{dc:dc,ac:ac},
                    beforeSend:function(){
                        $(".ajax-loader").show();
                    },
