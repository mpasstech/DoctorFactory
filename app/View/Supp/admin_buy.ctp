                ...
                <div class="middle-block">
                    ...
                    <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
                        ...
                        <div class="progress-bar channel_tap">
                            ...
                            <a id="v_app_channel_list" class='active' href="<?php echo Router::url('/admin/supp/buy'); ?>"><i class="fa fa-list"></i> Buy, Borrow & Rent List</a>
                        ...
                        <div class="Social-login-box payment_bx">
                            <?php echo $this->Form->create('Search',array('type'=>'get','url'=>array('controller'=>'supp','action' => 'search_buy'),'admin'=>true)); ?>
                            <div class="form-group">
                                ...
                                <div class="col-sm-2">
                                    <?php echo $this->Form->label('&nbsp;'); ?>
                                    <div class="submit">
                                        <a href="<?php echo $this->Html->url(array('controller'=>'admin','action'=>'buy')) ?>"><button type="button" class="Btn-typ3" >Reset</button></a>
                                    </div>
                                </div>
                            </div>
                            <div class="clear"></div>
...
<script>
    $(document).ready(function(){
        ...
        $(document).on('click','#changeQuestReplyStatus',function(e){
            ...
            var thisButton = $(this);
            $.ajax({
                url: baseurl+'/admin/supp/change_buy_reply_status',
