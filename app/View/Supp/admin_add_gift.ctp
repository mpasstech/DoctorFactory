                   ...
                   <?php echo $this->element('support_admin_leftsidebar'); ?>
                    <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
                        <div class="progress-bar channel_tap">
                            ...
                            <a href="<?php echo Router::url('/admin/supp/add_gift'); ?>" class="active" ><i class="fa fa-list"></i> Add Gift</a>
                        </div>
                        ...
                        <div class="Social-login-box payment_bx">
                            ...
                            <div class="form-group">
                                <div class="col-sm-3 pull-right">
                                    <?php echo $this->Form->submit('Add Gift',array('class'=>'Btn-typ5','id'=>'addEvent')); ?>
                                </div>
                            </div>
