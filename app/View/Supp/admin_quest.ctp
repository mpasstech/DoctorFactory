                ...
                <div class="middle-block">
                    ...
                    <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
                        ...
                        <div class="progress-bar channel_tap">
                            ...
                            <a id="v_app_channel_list" class='active' href="<?php echo Router::url('/admin/supp/quest'); ?>"><i class="fa fa-list"></i> Quest List</a>
                        ...
                        <div class="Social-login-box payment_bx">
                            <?php echo $this->Form->create('Search',array('type'=>'get','url'=>array('controller'=>'supp','action' => 'search_quest'),'admin'=>true)); ?>
...
<script>
    $(document).ready(function(){
        ...
        $(document).on('click','#changeQuestReplyStatus',function(e){
            ...
            var thisButton = $(this);
            $.ajax({
                url: baseurl+'/admin/supp/change_quest_reply_status',
