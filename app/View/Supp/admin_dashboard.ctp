    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12 pull-right create-btn-box">
                <p style="color: #fff;font-size: 20px;">Total Leads  <?php echo $new_leads;?></p>
                ...
                <div class="middle-block">
                    ...
                    <div class="col-lg-9 col-md-9 col-sm-9 col-xs-9">
                        ...
                        <div class="Social-login-box dashboard_box" style="padding: 15px; 20px;">
                            <p style="text-align: right;"><a  style="text-decoration: underline;" target="_blank" href="<?php echo Router::url('/cron_jobs/update_functionality_stats.php',true); ?>" class="cron_btn">Click To Update States</a>
                                ...
                                <div class="row">
                                    <div class="form-group">
                                        <div class="col-sm-4">
                                            ...
                                            <?php echo $this->Form->input('thinapp_id',array('type'=>'select','label'=>"Select App",'empty'=>'All App','options'=>$type_array,'class'=>'form-control thinapp_id')); ?>
                                        </div>
                            ...
                            <div class="form-group char_group">
                                ...
                                <div class="row row_master">
                                    ...
                                    <h3>Functionality Stats Module Graph</h3>
                                ...
                                <div class="row row_master2" style="display: none;">
                                    <a href="javascript:void(0);" class="scr_sht_sub_chart"><i alt="Screen Shot of Chart" class="fa fa-photo"></i> Download Image</a>
                                    <h3>Sub Module Stats Graph</h3>
                                ...
                                <div class="row row_master3">
                                    <a href="javascript:void(0);" class="scr_sht_user_chart"><i alt="Screen Shot of Chart" class="fa fa-photo"></i> Download Image</a>
                                    <h3>Users Stats Graph</h3>
                                    <img  style="display: none;" src="<?php echo Router::url('/img/ajaxloader.gif',true); ?>"  class="ajax-loader3">
                                    <div class="col-sm-12 user_module_chart_div"  style="height: 100%;">
                                    </div>
                                </div>
...
<script type="text/javascript">
    $(function(){
        ...
        function load_bar_chart(){
                ...
                $.ajax({
                    type:'POST',
                    url: baseurl+"/admin/supp/load_bar_chart_graph",
        ...
        function load_user_bar_chart(){
            var tid = $(".thinapp_id").val();
            var fd = $(".from_date").val();
            var td = $(".to_date").val();
            $.ajax({
                type:'POST',
                url: baseurl+"/admin/supp/load_user_chart_graph",
                data:{tid:tid,fd:fd,td:td},
                beforeSend:function(){
                    $(".ajax-loader3").show();
                },
                success:function(data){
                    $(".user_module_chart_div").html(data);
                    $(".ajax-loader3").hide();
                },
                error: function(data){
                    $(".ajax-loader3").show();
