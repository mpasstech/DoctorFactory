...
<div class="Inner-banner">
    <div class="container">
        <div class="row">
            <!--  SLIDER IMAGE -->
            <div class="col-lg-5 col-md-5 col-sm-12 col-xs-12 inner-page-text"> <h2>Contact List</h2> </div>
               ...
               <div class="middle-block">
                   <?php echo $this->element('support_admin_leftsidebar'); ?>
                    <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
                            ...
                            <?php echo $this->Form->create('Search',array('type'=>'get','url'=>array('controller'=>'supp','action' => 'search_static_query_list'),'admin'=>true)); ?>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-3">
                                 ...
                                 <div class="col-xs-3">
                                     ...
                                     <?php echo $this->Form->input('department_from',array( 'label' => 'Search by Department','empty'=>'All Department','type'=>'select','options'=>$type_array,'class'=>'form-control message_type cnt')); ?>
                                 </div>
                                ...
                                <div class="col-xs-3">
                                    ...
                                    <button type="submit" class="filter_btn">Submit</button>

                                    <a href="<?php echo Router::url('/admin/supp/static_query_list',true); ?>"><button type="button" class="filter_btn">Reset</button></a>
                                ...
                                <table class="table">
									...
									foreach ($data as $key => $value){
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo mb_strimwidth($value['AppEnquiry']['department_from'], 0, 50, '...'); ?></td>
    ...
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    <?php echo $this->Form->input('reply', array('type'=>'textarea','label'=>false,'required'=>true,'placeholder'=>'Write Your Message here','class'=>'form-control input-lg ped','id'=>'reply','style'=>(array('box-shadow'=>'0px 0px 0px','border-radius'=>'0px','border'=>'0px none')))); ?>
...
<script>
    $(document).ready(function(){
        ...
        $(document).on('click','#acceptThis',function(e) {
            var conf = confirm("Do you want to accept this task task?");
        ...
        $(document).on('click','#closeThis',function(e) {
            var conf = confirm("Do you want to close this task task?");
            if(conf == false){ return false; }
            var rowID = $(this).attr('enquiry-id');
            var thisButton = $(this);
            $.ajax({
