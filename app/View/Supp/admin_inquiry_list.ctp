<div class="Inner-banner">
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-5 col-md-5 col-sm-12 col-xs-12 inner-page-text"> <h2>Enquiry List</h2> </div>
                   ...
                   <?php echo $this->element('support_admin_leftsidebar'); ?>
                    <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
                        ...
                        <div class="Social-login-box payment_bx">
                            ...
                            <?php echo $this->Form->create('Search',array('type'=>'get','url'=>array('controller'=>'supp','action' => 'search_inquiry_list'),'admin'=>true)); ?>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-2">
                                    <?php echo $this->Form->label('&nbsp;'); ?>
                                    <div class="submit">
                                        <a href="<?php echo $this->Html->url(array('controller'=>'supp','action'=>'inquiry_list')) ?>"><button type="button" class="Btn-typ3" >Reset</button></a>
                                    </div>
                                </div>
                                ...
                                <table class="table">
									...
									foreach ($data as $key => $value){
                                        ...
                                        <tr>
											...
											<td>
											<?php 
													if(!empty($value['AppEnquiry']['attachment'])){
                                           		    echo $this->Html->link('', Router::url('/uploads/enquiry/',true).$value['AppEnquiry']['attachment'],
                                                    array('class' => 'fa fa-download','download','title' => 'Download attachment'));
                                                    } ?>
                                            </td>
