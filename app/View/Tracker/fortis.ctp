        ...
        <?php } else if(!empty($slide_list)){ ?>
            <div id="slider_box" class="col-xs-12 col-sm-12 col-md-6 col-lg-6" style="padding-right: 0; padding-left: 0;">
                ...
                <div  class="col-xs-12 col-sm-12 col-md-12 col-lg-12" style="padding-right: 0;padding-left: 0; display: <?php echo ($ShowHeader=='no')?'none':''; ?>">
                    <table class="heading_bar" style="width: 100%;">
                        <tr>
                            <td><h1><?php echo "Our Experts";//$thinapp_data['name']; ?></h1></td>
                        </tr>
                    </table>
                </div>
                ...
                <div style="padding-right: 0;padding-left: 0"  id="slideList" class="carousel slide carousel slide col-xs-12 col-sm-12 col-md-12 col-lg-12"  >
                    ...
                    <ol class="carousel-indicators">
                        <?php foreach ($slide_list as $key =>$data){ if(!empty($data['description'])){ ?>
    ...
    $(document).ready(function(){
        ...
        function load_list(){
            ...
            if(true){
                ...
                var actionName = (is_custom_app=="YES")?'load_ehcc_tracker':'load_fortis_tracker';
                ...
                $.ajax({
                    ...
                    data:{
                        t:t,doctor_id_string:doctor_id_string,logo:logo,pt:pt
                    },
                    beforeSend:function(){
                        index =0;
        ...
        function loadUpcomingList(){
            if(thin_app_id=='607' && $(".token_li:visible").length ==1){
                ...
                $.ajax({
                    ...
                    success:function(data){ $("#"+doctor_id).closest(".load_tracker_div").find(".upcoming_patient_ul").html(data); }
                });
            }
        }
                    ...
                    events: {
                        ...
                        onStateChange: function (event) { 
                            if (event.data == YT.PlayerState.ENDED) {
                                ...
                                if(event.data === 0) { 
                                    currKey++; player.destroy(); showNext();
                                } 
                            }
        ...
        function showNext(){
            ...
            else
            {
                ...
                setedIntervalYoutube = setInterval(function(){showYoutube(duration)},2000);
            }
        }
