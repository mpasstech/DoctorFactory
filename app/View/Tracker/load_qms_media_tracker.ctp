...
<!-- <div class="scrolling-marquee-left" scrollamount="12" style="padding: 0; display: block;width: 100%;"> -->
<ul class="check_ul">
    <?php $counter = 0;
    ...
    foreach ($result_array as $service_name => $service_data) {
        $show_header = true; ?>



        <li class="check_li marquee-list">
        <?php if (count($result_array) > 1 && !empty($service_name)) { ?>
                ...
                <div class="service_data_container">
                        ...
                        <?php foreach ($service_data as $doctor_id => $doctor_data) {
                            if (count($border_color) == $counter) {
                                $counter = 0;
                            }
                            $lg = (count($result_array) > 4) ? '6' : '12';  ?>
                                ...
                                <div style="padding: 0;" class="<?php echo $widthclass; ?> load_tracker_div  ul_class">
                                    <div class="token_li" data-voice="<?php echo (array_key_exists($doctor_id, $voice_array)) ? $voice_array[$doctor_id] : ''; ?>" id="<?php echo $doctor_id; ?>" style="border:3px solid #0973B6; background: #F1FAFF; color: #fff;">
                                            ...
                                            <ul>
                                                ...
                                                <li style="text-align: right;padding: 5px 10px;">
                                                    <?php
                                                    $tokenColor = "#000;";
                                                    $closedClass = "";
    ...
    <label style="display: block;width: 100%;float: left;text-align: center;margin: 1rem 0; font-weight: 500;
    padding: 0.5rem;">
