...
<div class="container">
        ...
        <tr>
            ...
            <td align="right" valign="top" class="recept_detail_holder">
                ...
                <table>
                    ...
                    <tr><td align="left" class="title_holder"><b>IPD ID.:</b></td><td align="right"><?php if(!empty($ipdUniqueId)){  echo $ipdUniqueId; } else{ echo '-'; } ?></td></tr>
                        ...
                        <td class="biller_detail_holder" valign="top">
                            <table>
                                ...
                                <?php if(!empty($orderDetails['AppointmentStaff']['name'])){ ?>
                                    <tr><td align="left" valign="top" class="title_holder"><b>Settlement By:</b></td><td align="right"><?php echo ucwords($orderDetails['AppointmentStaff']['name']); ?></td></tr>
                                <?php } ?>
    ...
    <table class="product_detail_holder">
        ...
        <tr>
            ...
            <th colspan="3" align="left"><b>Particular</b></th>
            <th align="left"><b>Payment Via</b></th>
        ...
        <tr>
            ...
            <td class="" colspan="3">
                <?php
                    if($orderDetails['HospitalIpdSettlement']['payment_status']=='RECEIVED'){
                        echo "IPD Settlement (Deposit)";
                    }else {
                        echo "IPD Settlement (Refund)";
                    }
                ?>

                </td>
            <td class="" align="right"><i class="fa fa-inr" aria-hidden="true"></i> <?php echo $orderDetails['MedicalProductOrder']['payment_type_name']; ?></td>
            <td class="" align="right"><i class="fa fa-inr" aria-hidden="true"></i> <?php echo $orderDetails['MedicalProductOrder']['total_amount']; ?></td>
        </tr>
