...
<div class="container-fluid">
    <div class="row media-main-container media-attach">
        ...
        <?php foreach($mediaData AS $keyMedia => $media){ ?>
            <div class="row media-container media<?php echo $keyMedia; ?>" data-url="<?php echo $media['MediaMessage']['media_url']; ?>" id="media<?php echo $keyMedia; ?>" duration="<?php echo ($media['MediaMessage']['duration']*60)*1000; ?>" style="display:none;"  data-type="<?php echo $media['MediaMessage']['media_type']; ?>">
...
<script>
    ...
    function setContent(data){
        ...
        if(Object.keys(data).length > 0)
        {
            ...
            data.forEach(function(item, index){
                ...
                htmlForDoc += '</div>'+
                    '<div class="list-container '+patientName+item.current_token+' list-container-2 col-xs-6 col-sm-6 col-md-6 col-lg-6">';
    ...
    function getTrackerData(){
        ...
        $.ajax({
            url: baseurl+"tracker/load_tracker_opd_media",
            type:'POST',
    ...
    var mediaCount = <?php echo ($keyMedia == '')?0:$keyMedia; ?>;
