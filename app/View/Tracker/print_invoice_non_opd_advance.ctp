...
<a href="#" onClick="window.history.back();" class="previous">&laquo; Previous</a>
...
<div class="container">
    ...
    <table>
        <tr>
            <td align="left" valign="top" class="company_detail_holder">
                <h2><?php echo ($orderDetails['Thinapp']['receipt_header_title'] != '')?$orderDetails['Thinapp']['receipt_header_title']:$orderDetails['Thinapp']['name']; ?></h2>
                <div class="logo_img">
                    ...
                    <tr>
                        <td class="biller_detail_holder" valign="top">
                            <table>
                                ...
                                <?php if(!empty($orderDetails['AppointmentStaff']['name'])){ ?>
                                    <tr><td align="left" valign="top" class="title_holder"><b>Doctor:</b></td><td align="right"><?php echo ucwords($orderDetails['AppointmentStaff']['name']); ?></td></tr>
                                <?php } ?>
                                <?php if(!empty($orderDetails['AppointmentStaff']['DepartmentCategory']['category_name'])){ ?>
                                ...
                                <?php } ?>
                                <?php if(isset($orderDetails['AppointmentAddress']['address']) != ''){ ?>
                                    <tr><td align="left" valign="top" class="title_holder"><b>Address:</b></td><td align="right"><?php echo ucwords($orderDetails['AppointmentAddress']['address']); ?></td></tr>
                                <?php } ?>
                            </table>
                        </td>
                        ...
                        <td class="user_detail_holder" valign="top">
                            <table>
                                ...
                                <tr><td align="left" valign="top" class="title_holder"><b>Gender:</b></td><td align="right"><?php echo ucwords((isset($orderDetails['AppointmentCustomer']['gender']) && $orderDetails['AppointmentCustomer']['gender'] != '')?$orderDetails['AppointmentCustomer']['gender']:$orderDetails['Children']['gender']); ?></td></tr>
                                <?php if(is_array($age)){
                                    $ageStr = array();
                                    if($age['year'] > 0){
    ...
    <table class="product_detail_holder">
        ...
        <tr>
            ...
            <?php if($hospitalDepositData['HospitalDepositAmount']['discount'] > 0){ ?>
                <td class="tbl1-bottom col1 hide_dis" align="right"><b>Discount</b></td>
            <?php } ?>
            <?php if($hospitalDepositData['HospitalDepositAmount']['tds'] > 0){ ?>
                <td class="tbl1-bottom col1 hide_tax" align="right"><b>Tax</b></td>
            <?php } ?>
        ...
        <?php }
            ...
            <tr class="" >
                <td class="">1</td>
                <td class="" colspan="3">Deposit</td>
                <td class="" align="right"><i class="fa fa-inr" aria-hidden="true"></i> <?php echo $hospitalDepositData['HospitalDepositAmount']['amount']; ?></td>
                <td class="" align="center"> <?php echo 'X'; ?></td>
                <td class="" align="left"> 1</td>
                <?php if($hospitalDepositData['HospitalDepositAmount']['discount'] > 0){ ?>
                    <td class="hide_dis" align="right" ><?php echo $hospitalDepositData['HospitalDepositAmount']['discount']; ?></td>
                <?php } ?>
                <?php if($hospitalDepositData['HospitalDepositAmount']['tds'] > 0){ ?>
                    <td class="hide_tax" align="right"><?php echo $hospitalDepositData['HospitalDepositAmount']['tds']; ?></td>
                <?php } ?>
                <td class="" align="right"><i class="fa fa-inr" aria-hidden="true"></i> <?php echo $hospitalDepositData['HospitalDepositAmount']['amount']; ?></td>
            </tr>
        <?php }?>
        ...
        <tr>
            <th colspan="9" class="col_chk" align="right"><b>
                    <?php if($orderDetails['MedicalProductOrder']['status'] == 'ACTIVE'){ ?>
                        Total Payable Amount&nbsp;
                    <?php } else{ ?>
                        Total Refund Amount
                    <?php } ?>
                </b></th>
            <th colspan="1" align="right"><span class="double_underline"><u><b><i class="fa fa-inr" aria-hidden="true"></i> <?php echo $hospitalDepositData['HospitalDepositAmount']['amount']; ?></b></u></span></th>
        </tr>
