...
<header id="mu-hero" class="" role="banner">
    ...
    <div class="container" style="width: 100% !important; padding-left: 0;padding-right: 0; float: left;display: block;">
        ...
        <?php $col=12; $has_slider="";  ?>

        <div id="tracker_box" style="<?php if($thin_app_id==902){ echo "width:100% !important;"; } ?> padding-right: 0;padding-left: 0;" class="col-xs-12 col-sm-12 col-md-<?php echo $col; ?> col-lg-<?php echo $col; ?> <?php echo $has_slider; ?>">
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" style="padding-right: 0;padding-left: 0; display: <?php echo ($ShowHeader=='no')?'none':''; ?>">
                <table class="heading_bar" style="width: 100%;">
                    <tr>
                        ...
                        <td><h1><?php echo $thinapp_data['name']; ?></h1></td>
                        <td style="text-align: center;font-size: 4rem;display: none;">
                            <button  id="settingButton" >
                                <i class="fa fa-gear" style="font-size: 2.5rem;"></i>
                                <sapn style="display: block;font-size: 1rem;text-align: center" id="show_count">- / -</sapn>
                            </button>
                        </td>
                    </tr>
                </table>
            ...
            <?php if(!empty($patientToken)){ if($patientToken['sub_token']=="NO"){ ?>
                <div class="col-md-12 current_token_box" style="padding: 0 5px;">
        ...
        <?php if(!empty($thinapp_data['tune_tracker_media'])){ ?>
            <div class="marq_div">
                <marquee scrollamount="10" style="padding: 0; display: block;width: 100%;"><?php echo $thinapp_data['tune_tracker_media']; ?></marquee>
            </div>
        <?php } ?>
    ...
    <img  id="bottomLogoMpass" style="bottom: 0px;right: 0px; background: #fff; z-index: 999999;padding: 10px;" src="https://s3-ap-south-1.amazonaws.com/mengage/20230327170026266608522.png" >
    ...
    $(document).ready(function(){
        ...
        if(setting){
            ...
            $(".doc_checkbox").each(function(){
                ...
                settingArray.push({"id":id,"checked":true});
            });
        ...
        socket.on( 'updateToken', function( data ) {
            ...
            if(data.thin_app_id==thin_app_id){
                ...
                $(".doctor_box_"+data.associate_counter_id).hide();
                    ...
                    if(data.activeTokens!=""){
                        try{
                            ...
                            $.each(activeTokenArray,function(index,value){
                                ...
                                if(updateToken!=""){
                                    $("#"+value.dId).show();
                                    $(".token_num_lbl_"+value.dId).html(updateToken);
                                }
                            });
                        }catch (e) {
                ...
                if(data.patient_name){
                    pat_name = (data.patient_name.search("Patient") < 0)?data.patient_name:"";
                }
                ...
                if(setting=="" || (obj && obj.checked==true)){
                    ...
                    }else if(data.play==true && data.token!=""){
                    ...
                    }else if(data.play==false && data.token!=""){
        ...
        $(document).on("click","#settingButton",function(evt){
            ...
            $("#setting_doctor_list_box input[type='checkbox']").trigger('change');
        ...
        function load_list(){
            ...
            $.ajax({
                type:'POST',
                url: baseurl+"tracker/load_live_tracker",
                data:{
                    t:t,logo:logo
                },
                beforeSend:function(){
        ...
        function play(audio,doctor_id,storageKey,  callback) {
            ...
            try {
                if(audioRunning == false){
                    ...
                    $("#"+doctor_id).closest('.ul_class').find(".token_li").addClass("blink");
                    var colorCode = $("#"+doctor_id).closest('.ul_class').attr("data-bg");
                    $(".zoom .token_number, .zoom .service_name").css("background-color", colorCode+"");

                    setTimeout(function(){
                        $("#"+doctor_id).closest('.ul_class').find(".token_li").removeClass("blink");
                        $("#"+doctor_id).closest('.ul_class').find(".token_li .token_number").removeAttr("style");
                    },6000);
