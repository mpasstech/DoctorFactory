...
<div class="Inner-banner">
    <div class="container">
        <div class="row">
            <!--  SLIDER IMAGE -->
            <div class="col-lg-5 col-md-5 col-sm-12 col-xs-12 inner-page-text"> <h2>Update Event</h2> </div>
                        ...
                        <div class="Social-login-box payment_bx">
                            ...
                            <div class="form-group">
                                <div class="col-sm-12">
                                    ...
                                    <?php echo $this->Form->input('tags',array('type'=>'text','placeholder'=>'Tags (comma separated)','label'=>false,'id'=>'tags','class'=>'form-control cnt','required'=>true)); ?>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <div class="col-sm-12">
                                    ...
                                    <?php echo $this->Form->input('contact_phone',array('type'=>'text','placeholder'=>'Contact phone','label'=>false,'id'=>'contact_phone','class'=>'form-control cnt','required'=>true,'oninvalid'=>"this.setCustomValidity('Please insert valid mobile number.')",'pattern'=>'[0-9]{10}')); ?>
                                </div>
                            </div>
                            ...
                            <div class="form-group" id="channelContainer" style="display: <?php echo ($this->request->data['Event']['channel_id'] == 0)?'none':'block'; ?>;">
                                <div class="col-sm-12">
                            ...
                            <div class="form-group">
                                <div class="col-sm-3 pull-right">
                                    <?php echo $this->Form->submit('Update Event',array('class'=>'Btn-typ5','id'=>'updateEvent')); ?>
                                </div>
                            </div>
    ...
    $(document).ready(function () {
        $(document).on('click','#selectAddressFromMap',function () {
            ...
            setTimeout(function () {
                    ...
                    var pos = {
                        lat: <?php echo $this->request->data['Event']['latitude']; ?>,
                        lng: <?php echo $this->request->data['Event']['longitude']; ?>
                    };
