                ...
                <div class="middle-block">
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        ...
                        <div class="Social-login-box payment_bx">
                            <h3 class="screen_title">Prescription Tag List</h3>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                                ...
                                                if($list['thinapp_id']!=0){
                                                    ...
                                                    echo $this->Html->link('',Router::url('/app_admin/edit_prescription_tag/',true).base64_encode($list['id']),
                                                        array('class' => 'fa fa-edit', 'title' => 'Edit cms'));
                                                    echo "</div>";
                                                    echo "<div class='action_icon'>";
                                                    echo $this->Html->link('','javascript:void(0);',
                                                        array('data'=>Router::url('/app_admin/delete_prescription_tag/',true).base64_encode($list['id']),'class' => 'fa fa-trash delete_cms', 'title' => 'Delete this Tip.'));
                                                    echo "</div>";
                                                }else if($list['thinapp_id']==0){
                                                    echo "<div class='action_icon'>";
                                                   echo $this->Html->link('',Router::url('/app_admin/copy_prescription_tag/',true).base64_encode($list['id']),
