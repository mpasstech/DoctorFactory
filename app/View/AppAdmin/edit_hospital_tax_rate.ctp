        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="middle-block">
                    <h3 class="screen_title"> Edit Tax Rate</h3>
                    ...
                    <?php echo $this->element('hospital_tax_rate_inner_tab'); ?>
                            ...
                            <div class="tab-content">
                                ...
                                <?php echo $this->Form->create('HospitalTaxRate',array('type'=>'file','method'=>'post','class'=>'form-horizontal sub_frm')); ?>
                                <div class="form-group">
                                    <div class="col-sm-6">
                                        <?php echo $this->Form->input('name',array('type'=>'text','placeholder'=>'','label'=>'Enter Tax Name','class'=>'form-control cnt','required'=>'required')); ?>
                                    </div>
                                    <div class="col-sm-2">
                                        <?php echo $this->Form->input('rate',array('type'=>'text','placeholder'=>'','label'=>'Enter Tax Rate','class'=>'form-control cnt','required'=>'required')); ?>
                                    </div>
                                    <div class="col-sm-2">
