<div class="Inner-banner">
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-5 col-md-5 col-sm-12 col-xs-12 inner-page-text"> <h2>Sell Item List</h2> </div>
                ...
                <div class="middle-block">
                    ...
                    <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
                        ...
                        <div class="progress-bar channel_tap">
                            <a id="v_app_channel_list" class='active' href="<?php echo Router::url('/app_admin/sell'); ?>"><i class="fa fa-list"></i> Sell Item List</a>
                            <a id="v_add_channel" href="<?php echo Router::url('/app_admin/add_sell_item'); ?>" ><i class="fa fa-globe"></i> Add Sell Item</a>
                            <a id="v_add_channel" href="<?php echo Router::url('/app_admin/permit_sell'); ?>" ><i class="fa fa-globe"></i> Permit Sell Item</a>
                        </div>

                        <div class="Social-login-box payment_bx">
                            <?php echo $this->Form->create('Search',array('type'=>'get','url'=>array('controller'=>'app_admin','action' => 'search_sell'),'admin'=>true)); ?>
                            <div class="form-group">
                                ...
                                <div class="col-sm-2">
                                    <?php echo $this->Form->label('&nbsp;'); ?>
                                    <div class="submit">
                                        <a href="<?php echo $this->Html->url(array('controller'=>'app_admin','action'=>'sell')) ?>"><button type="button" class="Btn-typ3" >Reset</button></a>
                                    </div>
                                </div>
                            </div>
                            <div class="clear"></div>
                                        ...
                                        <table class="table">
                                            ...
                                            foreach ($sellItems as $key => $value){
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <button type="button" id="changeSellStatus" class="btn btn-primary btn-xs"  sell-id="<?php echo $value['SellItem']['id']; ?>" ><?php echo $value['SellItem']['status']; ?></button>
                                                    </td>
                                                    <td>
                                                        <button type="button" id="viewSell" class="btn btn-primary btn-xs"  sell-id="<?php echo $value['SellItem']['id']; ?>" >VIEW</button>
                                                    </td>
                                                    <td>
                                                        <?php if($value['SellItem']['user_id']==$login['User']['id']){ ?>
                                                            <a href="<?php echo $this->Html->url(array('controller'=>'app_admin','action'=>'sell_images',base64_encode($value['SellItem']['id']))) ?>" >
                                                                <button type="button" id="editSell" class="btn btn-primary btn-xs" >IMAGE</button>
                                                            </a>&nbsp;
                                                            <a href="<?php echo $this->Html->url(array('controller'=>'app_admin','action'=>'edit_sell_item',base64_encode($value['SellItem']['id']))) ?>" >
                                                                <button type="button" id="editSell" class="btn btn-primary btn-xs" >EDIT</button>
                                                            </a>
                                                            &nbsp;
                                                            <a href="javascript:void(0);" class="delete_sell" sell-id="<?php echo base64_encode($value['SellItem']['id']); ?>" >
    ...
    $(document).ready(function(){
        ...
        $(document).on('click','.delete_sell',function(e){
            ...
            if(confirm("Are you sure you want to delete ?")){
                window.location.href = baseurl+"/app_admin/delete_sell/"+sell_id;
            }
        });
                ...
                $(document).on('click','#changeSellStatus',function(e){
                    ...
                    var thisButton = $(this);
                    $.ajax({
                        url: baseurl+'/app_admin/change_sell_status',
                        data:{sellID:sellID},
                        type:'POST',
                        beforeSend:function(){
                ...
                $(document).on('click','#viewSell',function () {
                    ...
                    var thisButton = $(this);
                    $.ajax({
                        url: baseurl+'/app_admin/view_sell',
                        data:{sellID:sellID},
                        type:'POST',
                        beforeSend:function(){
                            $(thisButton).button('loading').html('<i class="fa fa-spinner fa-pulse">');
