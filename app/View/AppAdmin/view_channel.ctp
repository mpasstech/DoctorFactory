                    ...
                    <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                        <div class="Myaccount-left">
                            <div class="User-info-box">
                                ...
                                <?php
                                if(empty($post['Channel']['channel_image'])){
                                    $post['Channel']['channel_image'] =Router::url('/images/channel-icon.png',true);
                                }
                                ?>
                                <div class="user-img"><img src="<?php echo $post['Channel']['channel_image']; ?>" alt="user" /></div>
                                <div class="user-info"><p><?php echo $post['Channel']['channel_name']; ?></p></div>
                            </div>
                            <div class="Myaccount-links">
                                <p><a href="javascript:void(0);" ><i class="fa-pencil fa"> </i>&nbsp; Edit Channel Logo</a></p>
                            </div>
