    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="container">
            <div class="row">
                <!--box 1 -->
                <!--box 1 -->
                <h3 class="screen_title">Add Vaccination</h3>
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                               <div class="form-group">
                                    <div class="col-sm-5">
                                        ...
                                        <?php echo $this->Form->input('full_name',array('max'=>20,'oninvalid'=>"this.setCustomValidity('Please enter  vaccination name.')",'oninput'=>"setCustomValidity('')" ,'type'=>'text','placeholder'=>'','label'=>false,'id'=>'mobile','class'=>'form-control vac_name')); ?>
                                    </div>
                                   <div class="col-sm-3">
                                       <label>Sub Title (ex. Hep-B,OPV)</label>
                                       <?php echo $this->Form->input('vac_name',array('type'=>'text','placeholder'=>'','oninvalid'=>"this.setCustomValidity('Please enter  sub title.')",'oninput'=>"setCustomValidity('')" ,'label'=>false,'id'=>'mobile','class'=>'form-control cnt')); ?>
                                   </div>
                                   <div class="col-sm-2">
                                       <label>Dose Type</label>
                                       <?php $options = array('Dose' => 'Dose', 'Booster' => 'Booster');
                                       ?>
                                       <?php echo $this->Form->input('dose_label',array('type'=>'select','label'=>false,'options'=>$options,'class'=>'form-control dose_label')); ?>
                                   </div>

                                   <div class="col-sm-2">
                                       <label>Dose Number</label>
                                       <?php for($i=1;$i<=20;$i++) $dose_cnt[$i]=$i;?>
                                       <?php echo $this->Form->input('dose_number',array('type'=>'select','label'=>false,'options'=>$dose_cnt,'class'=>'form-control dose_number')); ?>
                                   </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-5 border_div">
                                <div class="radio_lbl_vac">
                                    ...
                                    $attributes = array('value'=>'BIRTH','legend' => "When to given this vaccination.",'class'=>'radio-inline','div'=>'label');
                            ...
                            <div class="col-sm-6 border_div">
                                ...
                                <div class="col-sm-4 week_div">
                                    <?php for($i=1;$i<=20;$i++) $week_cnt[$i]=$i;?>
                                    <?php echo $this->Form->input('week',array('type'=>'select','label'=>"Week",'options'=>$week_cnt,'class'=>'form-control week')); ?>
                                </div>

                                <div class="col-sm-4 year_div">
                                    <?php for($i=0;$i<=20;$i++) $year_cnt[$i]=$i;?>
                                    <?php echo $this->Form->input('year',array('type'=>'select','label'=>"Year",'options'=>$year_cnt,'class'=>'form-control year')); ?>
                                </div>
...
<script>
    $(document).ready(function(){
        ...
        $(document).on('change','.vac_name, .week, .year, .month, .radio_lbl_vac [type=radio]',function () {
            showVacLabel();
        });
