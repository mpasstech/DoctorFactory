...
<head>
    ...
    <script>
        ...
        $url = str_replace('print_invoice','print_prescription',$url);
        ?>
        var prescriptionURL = '<?php echo Router::url('/',true); ?><?php echo $url; ?>';
    </script>
    ...
    <table>
        <tr>
            <td align="left" valign="top" class="company_detail_holder">
                ...
                <div class="logo_img">
                    <?php if($appointmentData['Thinapp']['logo'] != ''){ ?>
                        <img src="<?php echo $appointmentData['Thinapp']['logo']; ?>" >
                    <?php } ?>
