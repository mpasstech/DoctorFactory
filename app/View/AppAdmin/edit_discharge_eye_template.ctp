        ...
        <div class="container">
            <div class="row">
                ...
                <div class="middle-block">
                    ...
                    <h3 class="screen_title">Edit Discharge Template</h3>
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 custom_form_box print_box">
                        ...
                        <div class="value_form col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-1">
                                    <label>Status</label>
                                    <?php echo $this->Form->input('status',array('type'=>'select','options'=>array('ACTIVE'=>'Active','INACTIVE'=>'Inactive'),'label'=>false,'class'=>'form-control cnt')); ?>
