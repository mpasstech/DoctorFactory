                ...
                <div class="middle-block">
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        ...
                        <div class="Social-login-box payment_bx">
                            ...
                            <?php echo $this->Form->create('CmsPage',array('type'=>'file','method'=>'post','class'=>'form-horizontal')); ?>
                            ...
                            <div class="form-group content_div" style="display:none;">
                                <div class="col-sm-12">
                                    <label>Content</label>
                                    <?php echo $this->Form->input('description',array('type'=>'textarea','placeholder'=>'Channel description','label'=>false,'id'=>'editor1','class'=>'form-control content_input')); ?>                                </div>
                            </div>
