                ...
                <div class="middle-block">
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        ...
                        <div class="Social-login-box payment_bx">
                            ...
                            <h3 class="screen_title">Child Milestone</h3>
                            ...
                            <?php if(!empty($channel)){ ?>
                                <table class="table">
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo ($list['thinapp_id'] ==0)?"YES":"NO"; ?></td>
                                        ...
                                        <td>
                                            ...
                                            <div class="action_icon">
                                                ...
                                                if($list['thinapp_id']!=0){
                                                    echo "<div class='action_icon'>";
                                                    echo $this->Html->link('',Router::url('/app_admin/edit_child_milestone/',true).base64_encode($list['id']),
                                                        array('class' => 'fa fa-edit', 'title' => 'Edit cms'));
                                                    echo "</div>";

                                                    echo "<div class='action_icon'>";
                                                    echo $this->Html->link('','javascript:void(0);',
                                                        array('data'=>Router::url('/app_admin/delete_child_milestone/',true).base64_encode($list['id']),'class' => 'fa fa-trash delete_cms', 'title' => 'Delete this Tip.'));
                                                    echo "</div>";

                                                }else if($list['thinapp_id']==0){
                                                    echo "<div class='action_icon'>";
                                                    echo $this->Html->link('',Router::url('/app_admin/copy_child_milestone/',true).base64_encode($list['id']),
                                                        array('class' => 'fa fa-copy', 'title' => 'Copy cms'));
                                                    echo "</div>";
                                                }
