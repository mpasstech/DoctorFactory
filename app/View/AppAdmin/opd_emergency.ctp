                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 custom_form_box">
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hospital_search_box">
                            ...
                            <div class="row search_main">
                                <?php echo $this->Form->create('Search',array('type'=>'get','url'=>array('controller'=>'app_admin','action' => 'search_opd_emergency'))); ?>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-2 action_btn" >
                                        <div class="input text">
                                            ...
                                            <a class="btn btn-warning resteButton" href="<?php echo $this->Html->url(array('controller'=>'app_admin','action'=>'opd_emergency')) ?>">Reset</a>
                                    ...
                                    <?php foreach ($opd_list as $key => $list){
                                        ...
                                        <tr>
                                            ...
                                            <td>
												...
												<a class="btn btn-xs btn-info" href="<?php echo Router::url('/app_admin/register_emergency_patient/',true).$patient_type.'/'.$patient_id; ?>"><i class="fa fa-sign-in"></i> Register To Emergency</a>
                                                ...
                                                <!--button class="btn btn-xs btn-success"><i class="fa fa-file"></i> Receipt</button>
                                                <button class="btn btn-xs btn-warning"><i class="fa fa-history"></i> History</button-->
