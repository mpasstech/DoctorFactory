                        ...
                        <div class="Social-login-box payment_bx">
                            ...
                            <div class="form-group" style="border-bottom: 1px solid;">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <b>UHID:&nbsp;&nbsp;&nbsp;&nbsp;</b><?php echo (isset($patientData['AppointmentCustomer']))?$patientData['AppointmentCustomer']['uhid']:$patientData['Children']['uhid']; ?>
                                </div>
                                <div class="col-md-3">
                                    <b>Patient Name:&nbsp;&nbsp;&nbsp;&nbsp;</b><?php echo (isset($patientData['AppointmentCustomer']))?$patientData['AppointmentCustomer']['first_name']:$patientData['Children']['child_name']; ?>
                                </div>
                                <div class="col-md-3">
                                    <b>Mobile Number:&nbsp;&nbsp;&nbsp;&nbsp;</b><?php echo (isset($patientData['AppointmentCustomer']))?$patientData['AppointmentCustomer']['mobile']:$patientData['Children']['mobile']; ?>
                                </div>
                                <div class="col-md-3">
                                    <b>Receipt Date:&nbsp;&nbsp;&nbsp;&nbsp;</b>
                                    <?php if($login['USER_ROLE'] =='RECEPTIONIST' || $login['USER_ROLE'] =='DOCTOR' || $login['USER_ROLE'] =='STAFF'){ ?>
                                        <input type="text" readonly="readonly" autocomplete="off" value="<?php echo date("d/m/Y"); ?>" name="receipt_date" required="true" class="form-control dateContainer" placeholder="Receipt Date">
                                    <?php }else{ ?>
                                        <input type="text" id="receipt_date" autocomplete="off" value="<?php echo date("d/m/Y"); ?>" name="receipt_date" required="true" class="form-control dateContainer" placeholder="Receipt Date">
                                    <?php } ?>

                                </div>
                                <div class="col-md-3">
                                    <b>Age/DOB:&nbsp;&nbsp;&nbsp;&nbsp;</b><?php echo (isset($patientData['AppointmentCustomer']))?$patientData['AppointmentCustomer']['age']:$patientData['Children']['dob']; ?>
                                </div>
                                <div class="col-md-3">
                                    <b>Gender:&nbsp;&nbsp;&nbsp;&nbsp;</b><?php echo (isset($patientData['AppointmentCustomer']))?$patientData['AppointmentCustomer']['gender']:$patientData['Children']['gender']; ?>
                                </div>
                                <div class="col-md-3">
                                    <b>Parent's Name:&nbsp;&nbsp;&nbsp;&nbsp;</b><?php echo (isset($patientData['AppointmentCustomer']))?$patientData['AppointmentCustomer']['parents_name']:$patientData['Children']['parents_name']; ?>
                                </div>
                                <div class="col-md-3">
                                    <b>Address:&nbsp;&nbsp;&nbsp;&nbsp;</b><?php echo (isset($patientData['AppointmentCustomer']))?$patientData['AppointmentCustomer']['address']:$patientData['Children']['patient_address']; ?>
                                </div>
                                </div>
                            </div>
                            <div class="clear"></div>
                            ...
                            <div class="form-group ">
                                <label class="min_head">Add Billing Detail</label>
                                <div class="row">
                            ...
                            <div class="form-group" >
                                ...
                                <div class="input text  col-md-2">
                                    ...
                                    <?php echo $this->Form->input('hospitalEmergencyID',array('type'=>'hidden','label'=>false,'value'=>$hospitalEmergencyID)); ?>
                                    <?php echo $this->Form->input('isEmergency',array('type'=>'hidden','label'=>false,'value'=>$isEmergency)); ?>
