                ...
                <div class="middle-block">
                    ...
                    <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12 custom_form_box">
                        ...
                        <?php echo $this->element('app_admin_inner_tab_offer'); ?>
                            ...
                            <?php if(!empty($channel)){ ?>
                                <table class="table">
                                    ...
                                    <?php foreach ($channel as $key => $list){
                                        if(empty($list['AppServiceOffer']['image'])){
                                            $list['AppServiceOffer']['image'] =Router::url('/images/channel-icon.png',true);
                                        }
                                        ?>
                                    <tr>
                                        <td><?php echo $key+1; ?></td>
                                        <td><img class="channel_icon_list" src="<?php echo $list['AppServiceOffer']['image'];?>"></td>
                                        <td><?php echo $list['AppServiceOffer']['title']; ?></td>
                                        <td><?php echo ucfirst($list['AppServiceOffer']['short_description']); ?></td>
                                        <td><?php echo $list['AppServiceOffer']['base_amount']; ?></td>
                                        <td><?php echo $list['AppServiceOffer']['offer_amount']; ?></td>
                                        <td><?php echo $list['AppServiceOffer']['start']; ?></td>
                                        <td><?php echo $list['AppServiceOffer']['end']; ?></td>
                                        <td><?php echo $list['AppServiceOffer']['status']; ?></td>
                                        <td>
                                            <div class="action_icon">
                                                <?php

                                                    echo $this->Html->link('', Router::url("/app_admin/edit_offer/".base64_encode($list['AppServiceOffer']['id']),true),
                            ...
                            <?php }else{ ?>
                                <div class="no_data">
                                    <h2>You have no offer available.</h2>
                                </div>
                            <?php } ?>
