                            ...
                            <div class="tab-content">
                                ...
                                <div class="form-group">
                                    ...
                                    <?php } ?>
										...
										<div class="col-sm-4">
											<?php echo $this->Form->input('module_type',array('type'=>'select','label'=>'Module Type','options'=>array('HOSPITAL'=>'Hospital','LAB'=>'Lab','PHARMACY'=>'Pharmacy','SERVICE'=>'Service'),'class'=>'form-control cnt')); ?>
										</div>
