                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="action_icon">
                                                            <a class="btn btn-xs btn-info" href="<?php echo Router::url('/app_admin/edit_cms/',true).base64_encode($list['CmsPage']['id']); ?>"><i class="fa fa-edit"></i> Edit</a>
                                                        </div>
                                                        <div class="action_icon">
                                                            <?php $url = ($list['CmsPage']['request_load_type']=='CONTENT')?Router::url('/cms/view_cms.php?pi=',true).base64_encode($list['CmsPage']['id']):$list['CmsPage']['url']; ?>
    ...
    $(document).ready(function() {
        ...
        $(document).on('click', '.delete_cms', function (e) {
            ...
            if (confirm("Are you sure you want to delete this cms?")) {
                ...
                $.ajax({
                    url: baseurl + "/app_admin/delete_cms/" + id,
                    type: 'POST',
                    beforeSend: function () {
                    ...
                    success: function (res) {
                        ...
                        if (response.status == 1) {
                            window.location.href = baseurl + "/app_admin/cms";
                        } else {
