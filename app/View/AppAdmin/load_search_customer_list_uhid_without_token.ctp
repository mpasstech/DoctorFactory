    ...
    $(document).on("click","#userType",function(){
            ...
            else
            {
                    ...
                    $.ajax({
                        ...
                        data:{user_type:user_type,gender:gender,first_name:first_name,mobile:number,code:code,slot:slot,date:date,doctor:doctor,address:address,user:user,customer_id:customer_id,type:'NEW'},
                        beforeSend:function(){
                            isSearching = 'YES';
