                ...
                <div class="middle-block">
                    ...
                    <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
                        ...
                        <div class="progress-bar channel_tap">
                            ...
                            <a id="v_app_channel_list" href="<?php echo Router::url('/app_admin/buy'); ?>"><i class="fa fa-list"></i> Buy,Borrow & Rent List</a>

                            <a id="v_add_channel" class='active'  href="<?php echo Router::url('/app_admin/add_buy'); ?>" ><i class="fa fa-television"></i> Add Buy,Borrow & Rent</a>
                        ...
                        <div class="Social-login-box payment_bx">
                            ...
                            <div class="form-group">
                                <div class="col-sm-3 pull-right">
                                    <?php echo $this->Form->submit('Edit',array('class'=>'Btn-typ5','id'=>'addEvent')); ?>
                                </div>
                            </div>
