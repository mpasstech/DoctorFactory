        ...
        <div class="container">
            <div class="row">
                ...
                <div class="middle-block">
                    ...
                    <h3 class="screen_title">Edit IPD Patient Registration</h3>
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 custom_form_box">
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 patient_detail_section">
                            ...
                            <div class="form-group ">
                                ...
                                <div class="col-sm-1">
                                    <label>Title</label>
                                    <?php echo $this->Form->input('title',array('name'=>"data[AppointmentCustomer][title]",'value'=>@$this->request->data['AppointmentCustomer']['title'],'type'=>'select','options'=>$name_title,'label'=>false,'class'=>'form-control')); ?>
                                </div>
                                ...
                                <div class="col-sm-2">
                                    <label>Mobile</label>
                                    <?php echo $this->Form->input('mobile',array('value'=>substr($this->request->data['AppointmentCustomer']['mobile'],-10),'name'=>"data[AppointmentCustomer][mobile]",'type'=>'text','placeholder'=>'','label'=>false,'class'=>'form-control cnt')); ?>
                                </div>
                                ...
                                <div class="col-sm-2">
                                    ...
                                    <?php echo $this->Form->input('parents_name',array('name'=>"data[AppointmentCustomer][parents_name]",'type'=>'text','placeholder'=>'','label'=>false,'class'=>'form-control')); ?>
                                </div>
                                ...
                                <div class="col-sm-1 change_div_class">
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                    ...
                                    <?php echo $this->Form->input('',array('name'=>"data[HospitalIpd][appointment_staff_id]", 'value'=>$this->request->data['HospitalIpd']['appointment_staff_id'], 'required'=>'required','oninvalid'=>"this.setCustomValidity('Please select consultant.')",'oninput'=>"setCustomValidity('')" ,'empty'=>'Select Category','type'=>'select','label'=>false,'options'=>$doctor_list,'class'=>'form-control message_type cnt')); ?>
                                </div>

                                <?php $isAllowEditAdmitDate = $this->AppAdmin->isAllowEditAdmitDate(base64_decode($ipd_id)); ?>
                                <?php if($isAllowEditAdmitDate == true){ ?>
                                    ...
                                    <div class="col-sm-3">
                                        ...
                                        <?php echo $this->Form->input('',array('name'=>"data[HospitalIpd][admit_date]",'required'=>'required','value'=>$this->AppAdmin->dateFormat($this->request->data['HospitalIpd']['admit_date'],true),'type'=>'text','label'=>false,'class'=>'form-control admit_date')); ?>
                                    </div>

                                    <div class="col-sm-3">
                                        <label>Remark</label>
                                        <?php echo $this->Form->input('',array('name'=>"data[HospitalIpd][remark]",'value'=>$this->request->data['HospitalIpd']['remark'],'type'=>'text','label'=>false,'class'=>'form-control cnt')); ?>
                                    </div>
                                <?php } ?>
                                ...
                                <div class="col-sm-3">
                                    <?php echo $this->Form->input('', array('name'=>"data[HospitalIpd][appointment_address_id]",'value'=>$this->request->data['HospitalIpd']['appointment_address_id'],'type' => 'select','empty'=>'Select Address','options'=>$this->AppAdmin->get_app_address($login['User']['thinapp_id']),'label' => 'Select Address', 'class' => 'form-control','required'=>'required')); ?>
                                </div>
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <?php echo $this->Form->input('',array('name'=>"data[HospitalIpd][chief_complaint]",'type'=>'textarea','value'=>$this->request->data['HospitalIpd']['chief_complaint'],'placeholder'=>'','label'=>false,'class'=>'form-control cnt')); ?>
                                </div>
