                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 custom_form_box">
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hospital_search_box">
                            ...
                            <div class="row search_main">
                                <?php echo $this->Form->create('Search',array('type'=>'get','url'=>array('controller'=>'app_admin','action' => 'search_inventory_report_lab'))); ?>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-3 action_btn" >
                                        <div class="input text">
                                            ...
                                            <a class="btn btn-warning resteButton" href="<?php echo $this->Html->url(array('controller'=>'app_admin','action'=>'get_inventory_report_lab')) ?>">Reset</a>
