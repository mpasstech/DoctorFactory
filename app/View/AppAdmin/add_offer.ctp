...
<div class="Inner-banner">
    <div class="container">
        <div class="row">
            <!--  SLIDER IMAGE -->
            <div class="col-lg-5 col-md-5 col-sm-12 col-xs-12 inner-page-text"> <h2>Add Offer</h2> </div>
                               ...
                               <div class="form-group">
                                ...
                                <div class="form-group">
                                    <div class="col-sm-6">
                                        ...
                                        <?php echo $this->Form->input('start',array('type'=>'text','placeholder'=>'','label'=>false,'class'=>'start form-control cnt')); ?>
                                    </div>
...
<script>
    $(document).ready(function(){
        ...
        $('.end').data("DateTimePicker").date(new Date());
