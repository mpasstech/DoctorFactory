                ...
                <div class="middle-block">
                    ...
                    <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
                        ...
                        <div class="progress-bar channel_tap">
                            ...
                            <a id="v_add_channel" class='active' href="<?php echo Router::url('/app_admin/permit_buy'); ?>" ><i class="fa fa-globe"></i> Permit Buy,Borrow & Rent</a>
                        ...
                        <div class="Social-login-box payment_bx">
                            <?php echo $this->Form->create('Search',array('type'=>'get','url'=>array('controller'=>'app_admin','action' => 'search_permit_buy'),'admin'=>true)); ?>
                            <div class="form-group">
                                ...
                                <div class="col-sm-2">
                                    <?php echo $this->Form->label('&nbsp;'); ?>
                                    <div class="submit">
                                        <a href="<?php echo $this->Html->url(array('controller'=>'app_admin','action'=>'permit_buy')) ?>"><button type="button" class="Btn-typ3" >Reset</button></a>
                                    </div>
                                </div>
                            </div>
                            <div class="clear"></div>
                                        ...
                                        <table class="table">
                                            ...
                                            foreach ($quest as $key => $value){
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <button type="button" id="changeQuestPermission" class="btn btn-primary btn-xs"  quest-id="<?php echo $value['Quest']['id']; ?>" ><?php echo $value['Quest']['factory_publish_status']; ?></button>
                                                    </td>
...
<script>
    $(document).ready(function(){
        ...
        $(document).on('click','#changeQuestPermission',function(e){
            ...
            var thisButton = $(this);
            $.ajax({
                url: baseurl+'/app_admin/change_buy_factory_publish_status',
                data:{questID:questID},
                type:'POST',
                beforeSend:function(){
                    $(thisButton).button('loading').html('<i class="fa fa-spinner fa-pulse fa-2x fa-fw">');
