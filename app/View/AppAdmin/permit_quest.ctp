<div class="Inner-banner">
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-5 col-md-5 col-sm-12 col-xs-12 inner-page-text"> <h2>Permit <?php echo  ucfirst(base64_decode($this->request->query['qt'])); ?></h2> </div>
                ...
                <div class="middle-block">
                    ...
                    <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
                        ...
                        <div class="Social-login-box payment_bx">
                            <?php echo $this->Form->create('Search',array('type'=>'get','url'=>array('controller'=>'app_admin','action' => 'search_permit_quest'),'admin'=>true)); ?>
                            <div class="form-group">
                                ...
                                <div class="col-sm-2">
                                    <?php echo $this->Form->label('&nbsp;'); ?>
                                    <div class="submit">
                                        <a href="<?php echo $this->Html->url(array('controller'=>'app_admin','action'=>'permit_quest',"?"=>array('qt'=>$this->request->query['qt']))) ?>"><button type="button" class="Btn-typ3" >Reset</button></a>
                                    </div>
                                </div>
                            </div>
                            <div class="clear"></div>
                                        ...
                                        <table class="table">
                                            ...
                                            foreach ($quest as $key => $value){
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <button type="button" id="changeQuestPermission" class="btn btn-primary"  quest-id="<?php echo $value['Quest']['id']; ?>" ><?php echo $value['Quest']['factory_publish_status']; ?></button>
                                                    </td>
...
<script>
    $(document).ready(function(){
        ...
        $(document).on('click','#changeQuestPermission',function(e){
            ...
            var thisButton = $(this);
            $.ajax({
                url: baseurl+'/app_admin/change_quest_factory_publish_status',
                data:{questID:questID},
                type:'POST',
                beforeSend:function(){
