...
<div class="Inner-banner">
    <div class="container">
        <div class="row">
            <!--  SLIDER IMAGE -->
            <div class="col-lg-5 col-md-5 col-sm-12 col-xs-12 inner-page-text"> <h2>Ticket Report</h2> </div>
                    ...
                    <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
                         ...
                         <div class="Social-login-box">
                            ...
                            <?php echo $this->element('message'); ?>
                             <?php echo $this->Form->create('Search',array('type'=>'get','url'=>array('controller'=>'app_admin','action' => 'search_ticket_report_form','class'=>'form-control'),'admin'=>true)); ?>
                             <div class="form-group">
                                 <div class="col-sm-2">
                                     <?php echo $this->Form->input('status', array('type' => 'select','empty'=>'All','options'=>array('OPEN'=>'Open','INPROGRESS'=>'Inprogress','SOLVED'=>'Solved','CANCELLED'=>'Canceled'),'label' => 'Search by Status', 'class' => 'form-control')); ?>
                                 </div>
                                 <div class="col-sm-2">
                                     <?php echo $this->Form->input('type', array('type' => 'select','empty'=>'All','options'=>array('QUESTION'=>'Question','INCIDENT'=>'Incident','PROBLEM'=>'Problem','TASK'=>'Task'),'label' => 'Search by Type', 'class' => 'form-control')); ?>
                                 </div>

                                 <div class="col-sm-2">
                                     <?php echo $this->Form->input('date_from', array('type' => 'text','label' => 'Date From', 'class' => 'form-control datepicker_box')); ?>
                                 </div>

                                 <div class="col-sm-2">
                                     <?php echo $this->Form->input('date_to', array('type' => 'text','label' => 'Date To', 'class' => 'form-control datepicker_box')); ?>
                                 </div>
                                 ...
                                 <div class="col-sm-2">
                                     <?php echo $this->Form->label('&nbsp;'); ?>
                                     <div class="submit">
                                         <a href="<?php echo $this->Html->url(array('controller'=>'app_admin','action'=>'ticket_report')) ?>"><button type="button" class="Btn-typ3" >Reset</button></a>
                                     </div>
                                 </div>
                             </div>
...
<script>
    $(document).ready(function () {
        ...
        $('.datepicker_box').datepicker({autoclose: true});
