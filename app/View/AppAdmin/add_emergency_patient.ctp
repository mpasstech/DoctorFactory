        ...
        <div class="container">
            <div class="row">
                ...
                <div class="middle-block">
                    ...
                    <h3 class="screen_title">Add Emergency Patient</h3>
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 custom_form_box">
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 patient_detail_section">
                            ...
                            <!--div class="form-group ">
                                ...
                                <div class="col-sm-2">
                                    <label>UHID</label>
                                    <?php echo $this->Form->input('uhid',array('name'=>"uhid",'type'=>'text','placeholder'=>'','label'=>false,'id'=>'mobile','class'=>'form-control')); ?>
                                </div>
                                <div class="col-sm-2">
                                    <label>Mobile</label>
                                    <?php echo $this->Form->input('mobile',array('name'=>"mobile",'type'=>'text','placeholder'=>'','label'=>false,'class'=>'form-control cnt')); ?>
                                    <?php echo $this->Form->input('patient_id',array('name'=>"patient_id",'type'=>'text','placeholder'=>'','label'=>false,'class'=>'form-control cnt')); ?>
                                </div>
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                    ...
                                    <?php echo $this->Form->input('referred_by_name',array('name'=>"data[HospitalEmergency][referred_by_name]",'value'=>@$this->request->data['HospitalEmergency']['referred_by_name'],'type'=>'text','label'=>false,'class'=>'form-control cnt')); ?>
                                </div>
                                <div class="col-sm-3">
                                    <label>Referred By (Mobile)</label>
                                    <?php echo $this->Form->input('referred_by_mobile',array('name'=>"data[HospitalEmergency][referred_by_mobile]",'value'=>@$this->request->data['HospitalEmergency']['referred_by_mobile'],'type'=>'text',"onkeyup"=>"if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,'')","maxlength"=>"10","minlength"=>"10",'label'=>false,'class'=>'form-control cnt')); ?>
                                </div>
                                <div class="col-sm-6">

                                    <label>Chief Complaint</label>
                                    <?php echo $this->Form->input('chief_complaint',array('name'=>"data[HospitalEmergency][chief_complaint]",'value'=>@$this->request->data['HospitalEmergency']['chief_complaint'],'type'=>'text','placeholder'=>'','label'=>false,'class'=>'form-control cnt')); ?>
                                </div>
