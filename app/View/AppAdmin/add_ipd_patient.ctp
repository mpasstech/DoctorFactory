            ...
            <div class="row">
                ...
                <div class="middle-block">
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 custom_form_box">
                        ...
                        <?php echo $this->Form->create('AppointmentCustomer',array('url' => array('controller' => 'app_admin', 'action' => 'add_ipd_patient'),'class'=>'form-horizontal')); ?>
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 patient_detail_section">
                            ...
                            <div class="form-group ">
                                ...
                                <div class="col-sm-1">
                                    <label>Title</label>
                                    <?php echo $this->Form->input('title',array('name'=>"data[AppointmentCustomer][title]",'type'=>'select','options'=>$name_title,'label'=>false,'class'=>'form-control')); ?>
                                </div>
                                ...
                                <div class="col-sm-1">
                                    ...
                                    <label>DOB</label>
                                    <?php echo $this->Form->input('dob',array('autoComplete'=>'off','name'=>"data[AppointmentCustomer][dob]",'type'=>'text','placeholder'=>'','label'=>false,'class'=>'form-control dob','autoComplete'=>'off')); ?>
                                </div>
                                ...
                                <div class="col-sm-2 conceive_date_div" style="display: <?php echo @($this->request->data['AppointmentCustomer']['gender'] =='FEMALE')?'block':'none'; ?>;">
                                    ...
                                    <?php echo $this->Form->input('conceive_date',array('value'=>@$this->request->data['PregnancySemester']['conceive_date'],'name'=>"data[PregnancySemester][conceive_date]",'type'=>'text','placeholder'=>'DD/MM/YYYY','label'=>false,'class'=>'form-control')); ?>
                                </div>
                                ...
                                <div class="col-sm-2 conceive_date_div" style="display: <?php echo @($this->request->data['AppointmentCustomer']['gender'] =='FEMALE')?'block':'none'; ?>;">
                                    ...
                                    <?php echo $this->Form->input('expected_date',array('value'=>@$this->request->data['PregnancySemester']['expected_date'],'name'=>"data[PregnancySemester][expected_date]",'type'=>'text','placeholder'=>'DD/MM/YYYY','label'=>false,'class'=>'form-control')); ?>
                                </div>
                                ...
                                <div class="col-sm-6">
                                    <label>Address</label>
                                    <?php echo $this->Form->input('address',array('name'=>"data[AppointmentCustomer][address]",'type'=>'text','placeholder'=>'','label'=>false,'class'=>'form-control cnt')); ?>
                                </div>


                                <div class="col-sm-6">
                                    <label>Reason for Appointment</label>
                                    <?php echo $this->Form->input('',array('value'=>@$this->request->data['HospitalIpd']['reason_for_appointment'],"list"=>"reason_of_appointment",'type'=>'text','label'=>false,'class'=>'form-control cnt')); ?>
                                </div>
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            ...
                            <h3>Admit Entery Form</h3>
                            <div class="form-group">


                                <div class="col-sm-3">
                                    <label>Consultant</label>
                                    <?php echo $this->Form->input('',array('value'=>@$this->request->data['HospitalIpd']['appointment_staff_id'],'name'=>"data[HospitalIpd][appointment_staff_id]",'required'=>'required','oninvalid'=>"this.setCustomValidity('Please select consultant.')",'oninput'=>"setCustomValidity('')" ,'empty'=>'Select Consultant','type'=>'select','label'=>false,'options'=>$doctor_list,'class'=>'form-control message_type cnt')); ?>
                                </div>

                                <div class="col-sm-3">
                                    <label>Admission Ward/Room &nbsp; <a href="javascript:void(0);" class="get_bed_status">Bed Status </a></label>
                                    <?php echo $this->Form->input('',array('value'=>@$this->request->data['HospitalIpd']['hospital_service_category_id'],'name'=>"data[HospitalIpd][hospital_service_category_id]",'required'=>'required','oninvalid'=>"this.setCustomValidity('Please select ward/room.')",'oninput'=>"setCustomValidity('')" ,'empty'=>array('0'=>'Select Ward/Room'),'type'=>'select','label'=>false,'options'=>$ward_list,'class'=>'form-control ward_drp cnt')); ?>
                                </div>
                                ...
                                <div class="col-sm-3">
                                    ...
                                    <?php echo $this->Form->input('',array('value'=>@$this->request->data['HospitalIpd']['hospital_service_id'],'name'=>"data[HospitalIpd][hospital_service_id]",'required'=>'required','oninvalid'=>"this.setCustomValidity('Please select room/ward.')",'oninput'=>"setCustomValidity('')" ,'empty'=>array('0'=>'Select Room/Bad'),'type'=>'select','label'=>false,'options'=>$service_list,'class'=>'form-control service_drp')); ?>
                                </div>

                                <div class="col-sm-3">
                                    <label>Admit Date</label>
                                    <?php echo $this->Form->input('',array('value'=>@$this->AppAdmin->dateFormat($this->request->data['HospitalIpd']['admit_date'],true),'name'=>"data[HospitalIpd][admit_date]",'required'=>'required','value'=>date('d/m/Y h:i A'),'type'=>'text','label'=>false,'class'=>'form-control admit_date')); ?>
                                </div>
                                ...
                                <div class="col-sm-3">
                                    <label>Remark</label>
                                    <?php echo $this->Form->input('',array('value'=>@$this->request->data['HospitalIpd']['remark'],'name'=>"data[HospitalIpd][remark]",'type'=>'text','label'=>false,'class'=>'form-control cnt')); ?>
                                </div>

                                <div class="col-sm-3">
                                    <?php echo $this->Form->input('', array('name'=>"data[HospitalIpd][appointment_address_id]",'type' => 'select','empty'=>'Select Address','options'=>$this->AppAdmin->get_app_address($login['User']['thinapp_id']),'label' => 'Select Address', 'class' => 'form-control','required'=>'required')); ?>
                                </div>
                                <div class="col-sm-3">
                                    <label>Referred By (Name)</label>
                                    <?php echo $this->Form->input('',array('name'=>"data[HospitalIpd][referred_by_name]",'value'=>@$this->request->data['HospitalIpd']['referred_by_name'],'type'=>'text','label'=>false,'class'=>'form-control cnt')); ?>
                                </div>
                                <div class="col-sm-3">
                                    <label>Referred By (Mobile)</label>
                                    <?php echo $this->Form->input('',array('name'=>"data[HospitalIpd][referred_by_mobile]",'value'=>@$this->request->data['HospitalIpd']['referred_by_mobile'],'type'=>'text',"onkeyup"=>"if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,'')","maxlength"=>"10","minlength"=>"10",'label'=>false,'class'=>'form-control cnt')); ?>
                                </div>
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <?php echo $this->Form->input('',array('value'=>@$this->request->data['HospitalIpd']['chief_complaint'],'name'=>"data[HospitalIpd][chief_complaint]",'type'=>'textarea','placeholder'=>'','label'=>false,'class'=>'form-control cnt')); ?>
                                </div>
