...
<script>
    $(document).ready(function(){
        $(document).on('click','#changeEventStatus',function(e){
            ...
            var thisButton = $(this);
            $.ajax({
                url: baseurl+'/app_admin/change_event_status',
        ...
        $(document).on('click','#publishEvent',function(e){
            ...
            var thisButton = $(this);
            $.ajax({
                url: baseurl+'/app_admin/change_event_publish_status',
                data:{eventID:eventID},
                type:'POST',
                beforeSend:function(){
                    $(thisButton).button('loading').html('<i class="fa fa-spinner fa-pulse fa-2x fa-fw">');
        ...
        $(document).on('click','#viewEventResponse',function () {
            ...
            var thisButton = $(this);
            $.ajax({
                url: baseurl+'/app_admin/view_event_result',
                data:{eventID:eventID},
                type:'POST',
                beforeSend:function(){
                    $(thisButton).button('loading').html('<i class="fa fa-spinner fa-pulse fa-2x fa-fw">');
                ...
                success: function(result){
                    ...
                    if(result.status == 1)
                    {
                        ...
                        var link = baseurl+'app_admin/view_event_result_detail/'+btoa(eventID);
        ...
        $(document).on('click','.allow',function(e){
            ...
            var thisButton = $(this);
            $.ajax({
                url: baseurl+'/app_admin/change_event_allow',
