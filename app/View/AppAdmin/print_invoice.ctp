                    ...
                    <table>
                        <?php if(@$data['queue_number'] > 0 && $invoice_type =="OPD"){
                            ...
                            <?php if($data['show_paid_user_order_number_on_receipt']=="YES" && !empty($data['paid_receipt_number']) && $data['total_paid'] > 0){ ?>
                                <tr><td align="left" class="title_holder"><b>Paid Number:</b></td><td align="right"><b><?php echo $data['paid_receipt_number']; ?></b></td></tr>
                            <?php } ?>
                            ...
                            <?php if($data['show_token_time_on_receipt']=="YES"){ ?>
                                <tr><td align="left" class="title_holder"><b>Appointment Time:</b></td><td align="right"><b><?php echo ($data['emergency_appointment']=="YES")?date('h:i A',strtotime($data['appointment_created'])):$data['slot_time']; ?></b></td></tr>
                        ...
                        <?php if(!empty($data['bill_id'])){ ?>
                            <tr><td align="left" class="title_holder"><b>Bill No.:</b></td><td align="right">
                        ...
                        <?php if(@$data['hospital_ipd_id'] > 0 && ( $invoice_type =="IPD" || $invoice_type=="IPD_ADVANCE_DEPOSIT" )){ ?>
                            ...
                            <tr><td align="left" class="title_holder"><b>Admit Date.:</b></td><td align="right"><?php echo date("d M Y",strtotime($data['admit_date'])); ?></td></tr>

                            <?php if($data['admit_status']=='DISCHARGE') {
                                $discharge_date =  $this->AppAdmin->getIPDDischargeDate($data['hospital_ipd_id'],$login['User']['thinapp_id']); if(!empty($discharge_date)){   ?>
                                    <tr><td align="left" class="title_holder"><b>Discharge Date.:</b></td><td align="right"><?php echo date("d M Y",strtotime($discharge_date)); ?></td></tr>
                                <?php } } ?>
            ...
            <tr>
                <td class="doctor_patient_details" colspan="2">
                    <ul>
                        ...
                        <li><b>Payment Mode: </b><?php if(!empty($data['payment_type_name'])){  echo $data['payment_type_name']; } else{ echo '-'; } ?></li>
                        <?php if($data['show_date_on_receipt']=="YES" || $data['show_time_on_receipt']=="YES"){ ?>
                            <li>
                                <?php
                                $print_date=array();
