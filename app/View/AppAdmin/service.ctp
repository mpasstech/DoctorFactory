...
<div class="Inner-banner">
    <div class="container">
        <div class="row">
            <!--  SLIDER IMAGE -->
            <div class="col-lg-5 col-md-5 col-sm-12 col-xs-12 inner-page-text"> <h2>Services</h2> </div>
                            ...
                            <?php if(!empty($channel)){ ?>
                                <table class="table">
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $list['ServiceMenu']['name']; ?></td>
                                        <td><?php echo $list['ServiceMenu']['amount']; ?></td>
                                        <td><?php echo $list['ServiceMenuCategory']['name']; ?></td>
                                        <td><?php echo ($list['ServiceMenu']['status']); ?></td>
                                        <td>
                                            <div class="action_icon">
                                                <?php
                                                    echo $this->Html->link('', Router::url("/app_admin/edit_service/".base64_encode($list['ServiceMenu']['id']),true),
                                            ...
                                            <div class="action_icon">
                                                <?php
                                                echo $this->Html->link('', Router::url("/app_admin/delete_service/".base64_encode($list['ServiceMenu']['id']),true),
...
<script>
    $(document).ready(function(){
        ...
        $("#v_app_service_list").addClass('active');
