...
<div class="Inner-banner">
    <div class="container">
        <div class="row">
            <!--  SLIDER IMAGE -->
            <div class="col-lg-5 col-md-5 col-sm-12 col-xs-12 inner-page-text"> <h2>Add Member</h2> </div>
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        ...
                        <div class="Social-login-box payment_bx">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <label>Email</label>
                                    <?php echo $this->Form->input('email',array('type'=>'text','placeholder'=>'Email','label'=>false,'class'=>'form-control cnt')); ?>
