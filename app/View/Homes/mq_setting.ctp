<div class="modal-dialog modal-sm">
    <div class="modal-content">
        ...
        <div class="modal-body" style="padding: 0.1rem;">
            ...
            <?php if($type=='doctor'){ ?>
                <h3 class="box_heading"><?php echo $doctor_data['name']; ?></h3>
            <?php } ?>
                            ...
                            <div class="card-body">
                                ...
                                <form  enctype="multipart/form-data"  id="profile_form">
                                    <div class="col-12">
                                        ...
                                        <div class="name_container">
                                            <label>Country</label>
                                            <?php echo $this->Form->input('country_id',array('value'=>$doctor_data['country_id'],'oninvalid'=>"this.setCustomValidity('Please select country.')",'oninput'=>"setCustomValidity('')" ,'type'=>'select','label'=>false,'empty'=>array('0'=>'Select Country'),'options'=>$country_list,'class'=>'form-control country')); ?>
                                        </div>
                                        <div class="name_container">
                                            <?php $state_list =$this->AppAdmin->stateDropdown($doctor_data['country_id']);?>
                                            <label>State <i class="fa fa-spinner fa-spin state_spin" style="display:none;"></i> </label>
                                            <?php echo $this->Form->input('state_id',array('default'=>$doctor_data['state_id'], 'value'=>$doctor_data['state_id'],'oninvalid'=>"this.setCustomValidity('Please select state.')",'oninput'=>"setCustomValidity('')" ,'type'=>'select','label'=>false,'empty'=>array('0'=>'Select State'),'options'=>$state_list,'class'=>'form-control state')); ?>
                                        </div>

                                        <div class="name_container">
                                            <?php $city_list =$this->AppAdmin->cityDropdown($doctor_data['state_id']); ?>
                                            <label>City <i class="fa fa-spinner fa-spin city_spin" style="display:none;"></i></label>
                                            <?php echo $this->Form->input('city_id',array('default'=>$doctor_data['city_id'],'value'=>$doctor_data['city_id'],'oninvalid'=>"this.setCustomValidity('Please select city.')",'oninput'=>"setCustomValidity('')" ,'type'=>'select','label'=>false,'empty'=>array('0'=>'Select City'),'options'=>$city_list,'class'=>'form-control city')); ?>
                                        </div>

                                        <div class="name_container">
                                            <label>Tracker Slide Number</label>
                                            <?php echo $this->Form->input('other_check_in_queue_after_number',array('value'=>$doctor_data['other_check_in_queue_after_number'],'type'=>'number','label'=>false,'class'=>'form-control')); ?>
                                        </div>
                                        <div class="name_container">
                                            <label>Tracker Update Sequence</label>
                                            <?php $type_array = array('BOOKED_TOKEN_WISE'=>'Booked Token','SEQUENCE_WISE'=>'Sequence'); ?>
                                            <?php echo $this->Form->input('increase_token_on_traker',array("id"=>"increase_token_on_traker",'type'=>'select','value'=>$doctor_data['increase_token_on_traker'], 'label'=>false,'options'=>$type_array,'class'=>'form-control')); ?>
                                        </div>
                                        
                                         <div class="name_container">
                                            <label>Dashboard Screen</label>

                                            <?php $type_array = array('DIGITAL_TUD'=>'Digital TUD','DTI'=>'Daily Token Interface'); ?>
                                            <?php echo $this->Form->input('load_default_screen_on_dti',array("id"=>"load_default_screen_on_dti",'type'=>'select','value'=>$doctor_data['load_default_screen_on_dti'], 'label'=>false,'options'=>$type_array,'class'=>'form-control')); ?>
                                        </div>



                                        <div class="name_container">
                                            <label>Adavance booking days number</label>
                                    ...
                                    <div class="col-12 buton_box" style="float: left;" >
                                        <button type="reset" style="float: left;" class="btn btn-xs button btn-warning"><i class="fa fa-refresh" aria-hidden="true"></i> Reset</button>
                        ...
                        <div id="collapseFour" class="collapse" aria-labelledby="headingFour" data-parent="#accordion">
                            <div class="card-body">
                                ...
                                <form id="block_form">
                                    ...
                                    <h4 class="box_heading">Block Date</h4>
            ...
            <script type="text/javascript">
                $( document ).ready(function() {
                    ...
                    $(document).off('submit','#profile_form, #hour_form, #break_form, #logo_form, #service_form, #app_setting_form, #block_form');
                    $(document).on('submit','#profile_form, #hour_form, #break_form, #logo_form, #service_form, #app_setting_form, #block_form',function(e){
                        e.preventDefault();
