                    ...
                    <?php $counter=0; $discount =$tax = $total_amount =0;  foreach($invoiceData AS $key => $orderList ){
                        if($orderList['show_into_receipt']=="YES"){
                            ...
                            <tr>
                                ...
                                <td class="" ><a class="medicine_name" href="javascript:void()"><?php echo ucwords($orderList['service_name']); ?></a> </td>
                                ...
                                <td class="" align="left"> <a class="class_qty" href="javascript:void()"><?php echo $orderList['quantity']; ?></a></td>
                            </tr>
                                ...
                                <td colspan="4">
                                    <table class="sub_table">
                                        <tr>
                                            ...
                                            <td class="" align="left"><b>Amount :-</b> <i class="fa fa-inr" aria-hidden="true"></i> <a class="amount_a" href="javascript:void()"><?php echo $orderList['total_amount']; ?></a></td>
