    ...
    <div class="row tab_btn_div">
            ...
            <div class="row doctor_banner_img_sec">
                ...
                <div class="col-9" style="padding-right: 0px;">
                    <div class="service_sec">
                        ...
                        <?php if(!empty($service['offline'])){ ?>
                            <label class="dash_consulting_lbl"><i class="fa fa-building-o" aria-hidden="true"></i> Hospital/Clinic Visit <span><?php echo $service['offline']; ?> Rs/-</span></label>
                        <?php } ?>
                        <?php if(!empty($service['video'])){ ?>
                            <label class="dash_consulting_lbl"><i class="fa fa-video-camera" aria-hidden="true"></i> Video <span><?php echo $service['video']; ?> Rs/-</span></label>
                        <?php } ?>
                        <?php if(!empty($service['audio'])){ ?>
                            <label class="dash_consulting_lbl"><i class="fa fa-file-audio-o" aria-hidden="true"></i> Voice <span><?php echo $service['audio']; ?> Rs/-</span></label>
                        <?php } ?>
                        <?php if(!empty($service['chat'])){ ?>
                            <label class="dash_consulting_lbl"><i class="fa fa-comments-o" aria-hidden="true"></i> Chat <span><?php echo $service['chat']; ?> Rs/-</span></label>
                        <?php } ?>
        ...
        <div class="icon-div-btn col-4">
            <button class="tab-appointment" data-title="Book Token" id="app_btn" data-id="appointment">
                <i class="fa fa-stethoscope" aria-hidden="true"></i>Book Token
            </button>
        </div>
        ...
        <div class="icon-div-btn col-4" id="dash_medical_record" style="">
        ...
        <div class="icon-div-btn col-4" id="dash_patient_info" style="">
            <button class=" tab-blog" data-id="patient_info" data-title="Patient Info"><i class="fa fa-info" aria-hidden="true"></i>Patient Info</button>
        </div>
