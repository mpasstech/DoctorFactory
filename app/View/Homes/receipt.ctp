...
<div class="container">
    ...
    <table>
        <tr>
            <td align="left" valign="top" class="company_detail_holder">
                <h2><?php echo $bookingData['app_name']; ?></h2>
                <div class="logo_img">
                    <img src="<?php echo $bookingData['logo']; ?>">
                    ...
                    <tr>
                        <td class="biller_detail_holder" valign="top">
                            <table>
                                ...
                                <tr><td align="left" valign="top" class="title_holder"><b>Name:</b></td><td align="right"><?php echo $bookingData['app_name']; ?></td></tr>
                                <tr><td align="left" valign="top" class="title_holder"></td></tr>
                            </table>
                        </td>
    ...
    <table class="product_detail_holder">
        ...
        <tr>
            <td class="">1</td>
            <td class="" colspan="3">Consultation Charges ( Appointment )</td>
        ...
        <?php if($bookingData['convence_for'] == 'ONLINE' || $appointmentData['AppointmentCustomerStaffService']['emergency_appointment']=='YES'){ ?>
            <tr>
