<div class="Inner-banner">
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-5 col-md-5 col-sm-12 col-xs-12 inner-page-text"> <h2>Quest List</h2> </div>
                ...
                <div class="middle-block">
                    ...
                    <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
                        ...
                        <div class="progress-bar channel_tap">
                            ...
                            <a id="v_app_channel_list" class='active' href="<?php echo Router::url('/admin/admin/quest'); ?>"><i class="fa fa-list"></i> Quest List</a>

                            <a id="v_add_channel" href="<?php echo Router::url('/admin/admin/add_quest'); ?>" ><i class="fa fa-television"></i> Add Quest</a>
                        ...
                        <div class="Social-login-box payment_bx">
                            <?php echo $this->Form->create('Search',array('type'=>'get','url'=>array('controller'=>'admin','action' => 'search_quest'),'admin'=>true)); ?>
                            <div class="form-group">
                                ...
                                <div class="col-sm-2">
                                    <?php echo $this->Form->label('&nbsp;'); ?>
                                    <div class="submit">
                                        <a href="<?php echo $this->Html->url(array('controller'=>'admin','action'=>'quest')) ?>"><button type="button" class="Btn-typ3" >Reset</button></a>
                                    </div>
                                </div>
                            </div>
                            <div class="clear"></div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="action_icon" style="display:flex;">
                                                            ...
                                                            &nbsp;
                                                            <a href="<?php echo $this->Html->url(array('controller'=>'admin','action'=>'edit_quest',base64_encode($value['Quest']['id']))) ?>" >
...
<script>
    $(document).ready(function(){
        $(document).on('click','#changeQuestStatus',function(e){
            ...
            var thisButton = $(this);
            $.ajax({
                url: baseurl+'/admin/admin/change_quest_status',
        ...
        $(document).on('click','#viewQuest',function () {
            ...
            var thisButton = $(this);
            $.ajax({
                url: baseurl+'/admin/admin/view_quest',
                data:{questID:questID},
                type:'POST',
                beforeSend:function(){
                    $(thisButton).button('loading').html('<i class="fa fa-spinner fa-pulse fa-2x fa-fw">');
        ...
        $(document).on('click','#viewQuestResponse',function () {
            ...
            var thisButton = $(this);
            $.ajax({
                url: baseurl+'/admin/admin/view_quest_result',
                data:{questID:questID},
                type:'POST',
                beforeSend:function(){
                    $(thisButton).button('loading').html('<i class="fa fa-spinner fa-pulse fa-2x fa-fw">');
        ...
        $(document).on('click','#changeQuestReplyStatus',function(e){
            ...
            var thisButton = $(this);
            $.ajax({
                url: baseurl+'/admin/admin/change_quest_reply_status',
