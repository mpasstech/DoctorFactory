                ...
                <div class="middle-block">
                    ...
                    <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
                        ...
                        <div class="progress-bar channel_tap">
                            ...
                            <a id="v_app_channel_list" href="<?php echo Router::url('/admin/admin/quest'); ?>"><i class="fa fa-list"></i> Quest List</a>

                            <a id="v_add_channel" class='active'  href="<?php echo Router::url('/admin/admin/add_quest'); ?>" ><i class="fa fa-television"></i> Add Quest</a>

                            <a id="v_add_channel" href="<?php echo Router::url('/admin/admin/permit_quest'); ?>" ><i class="fa fa-globe"></i> Permit Quest</a>
