                ...
                <div class="middle-block">
                    ...
                    <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
                        ...
                        <div class="progress-bar channel_tap">
                            ...
                            <a id="v_app_channel_list" class='active' href="<?php echo Router::url('/admin/admin/buy'); ?>"><i class="fa fa-list"></i> Buy, Borrow & Rent List</a>
                        ...
                        <div class="Social-login-box payment_bx">
                            <?php echo $this->Form->create('Search',array('type'=>'get','url'=>array('controller'=>'admin','action' => 'search_buy'),'admin'=>true)); ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="action_icon" style="display:flex;">
                                                            ...
                                                            &nbsp;
                                                            <a href="<?php echo $this->Html->url(array('controller'=>'admin','action'=>'edit_buy',base64_encode($value['Quest']['id']))) ?>" >
...
<script>
    $(document).ready(function(){
        ...
        $(document).on('click','#changeQuestReplyStatus',function(e){
            ...
            var thisButton = $(this);
            $.ajax({
                url: baseurl+'/admin/admin/change_buy_reply_status',
