<!--/RIGHT-BOX--><?php //echo $this->layout; ?>
<div class="right-box">
      <!--/HEADING-->
<div class="top-box">
    <div class="tp-line">
    ...
    <tbody>
        ...
        <td>
            <?php echo $this->Form->create('Thinapp',array(/*'url' => array('controller'=>'Thinapps','action' => 'edit',$id), */'enctype'=>'multipart/form-data','admin'=>true)); ?>
             ...
             <?php echo $this->Form->input('Thinapp.channel_id',array('type'=>'hidden','value' => $thinapp['Thinapp']['channel_id']));?>
		...
		<tr>
         ...
         <tr>
		  ...
		  <td>
		     ...
		     <td> <?php echo $this->Form->input('Thinapp.start_date',array('type'=>'text','placeholder'=>'Start Date', 'label'=>false,'class'=>'form-control default_datetimepicker','id'=>'pwd','value'=>$thinapp['Thinapp']['start_date']));?>
		     ...
		     <td> <?php echo $this->Form->input('Thinapp.end_date',array('type'=>'text','placeholder'=>'End Date', 'label'=>false,'class'=>'form-control default_datetimepicker','id'=>'pwd','value'=>$thinapp['Thinapp']['end_date']));?>
