    ...
    <tbody>
        ...
        <table class="tablesorter" cellpadding="0">
		  ...
		  <td>
		     ...
		     <td> <?php echo $this->Form->input('Thinapp.start_date',array('type'=>'text','placeholder'=>'Start Date', 'label'=>false,'class'=>'form-control','id'=>'pwd'));?>
		     ...
		     <td> <?php echo $this->Form->input('Thinapp.end_date',array('type'=>'text','placeholder'=>'End Date', 'label'=>false,'class'=>'form-control','id'=>'pwd'));?>
