...
<head id ="row_content" class="row_content" >
    ...
    <?php echo $this->Html->script(array('jquery-3.5.1.min.js','bootstrap4.min.js','popper.min.js','sweetalert2.min.js','jquery.maskedinput-1.2.2-co.min.js','jquery-confirm.min.js','moment.js', 'wickedpicker.min.js')); ?>
    <?php echo $this->Html->css(array( 'bootstrap4.min.css','font-awesome.min.css','sweetalert2.min.css','jquery-confirm.min.css','wickedpicker.min.css'),array("media"=>'all')); ?>
                    ...
                    <div class="tab-content">
                        <div class="tab-pane active" role="tabpanel" >
                            ...
                            <div class="col-12">
                                ...
                                <input type="text" id ="entity_name" autocomplete="off" name="entity_name"  data-type="app_name" class="form-control validate_box">
                            </div>
                        ...
                        <div class="tab-pane counter_executive_div" role="tabpanel" >
                            <h5 class="counter_form_title form_title">Executive </h5>
                            <div class="col-12">
                            <label class="counter_label">Executive Name</label>
                            ...
                            <div class="col-12">
                                <label>Mobile Number</label>
                                <input type="number" id="counter_mobile"  autocomplete="off" maxlength="10" name="executive[counter_number][]"  class="form-control counter_number validate_box" data-type="mobile">
                            </div>
                            <div class="button-box">
                                <li><button type="button"  class="btn btn-primary next-step">Save & Next</button></li>
                        ...
                        <div class="tab-pane" role="tabpanel" >
                            ...
                            <div class="col-12" id="time_box">
                                ...
                                <div class="inner_box">
                                    ...
                                    <input type="text" id="time_from" value="10:00"  autocomplete="off" data-type="not_empty" name="service[time_from]" class="form-control time_box validate_box">
                                </div>
                                <div class="inner_box">
                                    <label style="width: 100%;display: block;">To Time</label>
                                    <input type="text" id="time_to" value="18:00" autocomplete="off" data-type="not_empty" name="service[time_to]" class="form-control time_box validate_box">
                                </div>
                            </div>
...
<script>
    $(document).ready(function () {
        ...
        $('#time_from').wickedpicker({now:$('#time_from').val(),twentyFour:true});
        $('#time_to').wickedpicker({now:$('#time_to').val(),twentyFour:true});
        ...
        $(document).on("input","#mobile_number",function (e) {

           $("#counter_mobile").val($(this).val());
        });
        ...
        $(document).on("click",".next-step, .skip",function (e) {
         ...
         $(document).on("change","#entity_type",function (e) {
            ...
            if(val=='HOSPITALS' || val=='DOCTOR_OPDS'){
                ...
                $(".counter_label").html("Doctor Name");
                $(".counter_form_title").html("Doctor");
            }else{
                $(".counter_label").html("Counter Name");
                $(".counter_form_title").html("Counter");
        ...
        $(document).on('click','.edit_info_btn',function(e){
            ...
            $.each(object_array,function (index,value) {
                if(value.id== id){
                    ...
                    console.log(data_object.is('input'));
                    ...
                    var update_dialog = $.confirm({
                        ...
                        buttons: {
                            ok: {
                                ...
                                action: function(e){
                                    ...
                                    var update_value = this.$content.find("input, select").val();
                        ...
                        onContentReady:function(){
                            ...
                            this.$content.find('.time_box').wickedpicker({twentyFour:true});
                        }
                    });
        ...
        function openFinalScreen(){
            if(btoa($("#otp").val())==$("#otp").attr('data-t')){
                ...
                var entity =$("#entity_type").val();
                var text = (entity =='HOSPITALS' || entity =='DOCTOR_OPDS')?'Doctor':'Counter';
                ...
                prev_dialog = $.confirm({
                       ...
                       /* pai: {
                        ...
                        ok: {
                            ...
                            action: function(e){
                                ...
                                $.ajax({
                                    type:'POST',
                                    url: baseurl+"qutot/save_web_app",
                                    ...
                                    success:function(response){
                                        ...
                                        if (response.status == 1) {
                                            ...
                                            var login_url = baseurl+"qutot/login";
                                            swal({
                                                type:'success',
                                                title: "Congratulation",
                                                html: "Your web app <span style='font-weight:600;font-size:1.3rem;color:#9cd29c;'>"+app_name+"</span> has been created successfully and we have send detail with username and password on what's app. For view your app please click on this link <a href="+login_url+" class='' >View Dashboard</a> ",
                    ...
                    onContentReady:function(){
                        ...
                        $('.time_box').wickedpicker({twentyFour:true});
        ...
        function loadPrevHtml(className, flag){
            ...
            $.ajax({
                type:'POST',
                url: baseurl+"qutot/form_preview/"+flag,
                data:$("#data_form").serialize(),
                beforeSend:function(){
                    $btn.text('Creating...');
                    $btn.attr('disabled',true);
