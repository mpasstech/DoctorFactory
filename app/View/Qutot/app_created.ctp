...
<div class="container">
    <div class="main_content" style="display: none;width: 100%;float: left;">
        <div class="row">
            ...
            <div class="col-12">
                ...
                <ul class="main_detail">
                    ...
                    <li>
                        ...
                        <label>One can also upload your logo, make changes your schedule and availability etc with the option of profile settings on upper right corner.</label>
                    </li>
                </ul>
            </div>
        </div>
...
<script>
    $(document).ready(function () {
        ...
        var login_dialog = $.confirm({
            title: 'Admin Login',
            content:"<div class='co'><label>Please enter password</label><input type='password' id='password' class='form-control'></div>",
            type: 'blue',
            buttons: {
                ok: {
                    text: "Login",
