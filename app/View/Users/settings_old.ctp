    ...
    <?php if(@$this->request->data['User']['image'] != ''){ ?>
        <div class="left-top-box" style="width:180px !important;">
            ...
            <div class="SLP_categoryBoxText" style="width:180px !important; float:left !important;">
                <a href="#"><button type="button" class="SEnd-btn6 pull-right" id="upload_user_img">Change Picture</button></a>  
            </div>
        </div>
    <?php }else{ ?>
        <div class="left-top-box" style="width:180px !important;">
...
<div class="account-setting-form">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10" style="width: 83.3333% !important;">
            ...
            <div style="display: none;"><?php echo $this->Form->file('image',array('id'=>'imag_upload','placeholder'=>'Image','label'=>false)); ?></div>
        </div>
    </div>
...
<?php echo $this->Html->script(array('bootstrap.min','jquery'));?>