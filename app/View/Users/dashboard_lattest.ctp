    ...
    <div class="container">
        ...
        <div class="left-box">
            ...
            <div class="top-heading">
                <h1>Channels</h1>
                <a href="javascript:;"><button  type="button" class="Add-btn pull-right" id="add_channel"><i class="fa fa-plus-circle"></i> Add New</button></a>
            </div>
                        ...
                        <div class="Channel-Box active" onclick="channelInfo('<?php echo $channel['id'] ?>', '<?php echo $channel['is_subscribe'] ?>')">
                            ...
                            <div class="Channel-right-box pull-right">
                                ...
                                <?php } else { ?>
                                    <p><?php echo $text; ?></p>
                                <?php } ?>
                                    <?php if($channel['is_public'] =='Y'){ echo 'Public'; } else{ echo 'Private'; } ?>
                            </div>
           ...
           ?>
           <div class="top-heading">
                <h1> <a href="#" id="index_page"> Pages </a></h1>
                <a href="javascript:;"><button  type="button" class="Add-btn pull-right" id="add_page"><i class="fa fa-plus-circle"></i> Add New</button></a>
            </div>
           <?php
           }
           ?>
        ...
        <div class="right-box">
            ...
            <div class="msg-box2">
                ...
                <div class="all-msg2">
                    <p>View history<span><?php echo count($messges); ?></span></p>
                </div>
                                        ...
                                        <h4 class="panel-title"> 
                                            <a style=" color:#000 !important;"> 
                                                ...
                                                if ($msg['Message']['action_type'] == 1) {
                                                    ...
                                                    echo ucfirst($msg['Message']['message']);
                                                } else {
                                            ...
                                            <div class="panel-body">
                                                <div class="SLP_categoryBoxText" style="width: 60%; float:left;">
                                                    <p style="font-size:14px; color:#6d6d6d; margin:0px;">
                                                       ...
                                                       echo  $msg = preg_replace($reg_exUrl, "<a href='$1' target='_blank'>$1</a>", $text);
                                                        ?>
                                                        <?php /*?> <textarea id="<?php echo $msg['Message']['id'];?>"  style="width: 750px;height:150px"><?php echo $msg; ?></textarea>
                                                         <a href="#" onclick="">Update Message</a>
                                                         <?php */?>
                                                    </p>
