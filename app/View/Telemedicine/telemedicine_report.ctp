                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 custom_form_box">
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            ...
                            <div class="row search_main">
                                <?php echo $this->Form->create('Search',array('type'=>'POST','url'=>array('controller'=>'telemedicine','action' => 'search_telemedicine_report'))); ?>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4 action_btn" >
                                        <div class="input text">
                                            ...
                                            <a class="btn btn-warning resteButton" href="<?php echo $this->Html->url(array('controller'=>'telemedicine','action'=>'telemedicine_report')) ?>">Reset</a>
                                         <!--   <a class="btn btn-success" href="<?php /*echo $this->Html->url(array('controller'=>'telemedicine','action'=>'setting')) */?>"><i class="fa fa-gear"></i> Setting</a>
-->
                                        </div>
