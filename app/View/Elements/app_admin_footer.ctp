    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 fotter-in1 wow bounceInRight">
                <div class="blog-text">
                    <div class="blog-txt">
                        <h2><img src="<?php echo Router::url('/images/logo.jpg',true)?>" alt=""/></h2>
                        ...
                        <div itemscope itemtype="http://schema.org/LocalBusiness">
                            <div itemprop="address" itemscope itemtype="http://schema.org/PostalAddress">
                                ...
                                <span itemprop=" telephone"> &nbsp; <i class="fa-mobile-phone fa"></i> +91-7412993344</span><br/>
                                <img src="<?php echo Router::url('/images/mail-icon.jpg',true)?>" alt="email" /><a itemprop="email" href="mailto:engage@mengage.in">engage@mengage.in</a>
                            </div>
                        </div>
                    </div>
                </div>
