    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 fotter-in1 wow bounceInRight">
                <div class="blog-text">
                    <div class="blog-txt">
                        <h2><img src="<?php echo Router::url('/images/logo.png?12354',true)?>" alt=""/></h2>
                        <p>

                        Delight your customer when he visits you with seamless experience of convenience and comfort.
                        </p>
                        <div itemscope itemtype="http://schema.org/LocalBusiness">
                            <div itemprop="address" itemscope itemtype="http://schema.org/PostalAddress">
                                ...
                                <span itemprop="postalCode">302019</span><br/>
