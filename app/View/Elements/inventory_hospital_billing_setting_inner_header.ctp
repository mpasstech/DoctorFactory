<div class="row" style="margin-top: 11px;">
    <div class="row">
        <div class=" billing_element col-md-12">
            <div class="hospital_service col-lg-12 col-md-12">
                <a href="<?php echo Router::url('/app_admin/hospital_service_hospital',true); ?>" >
...
<script>
    $(function () {
        ...
        }else if(action == 'hospital_service_hospital' || action =="add_hospital_service_hospital" || action=="edit_hospital_service_hospital"){
        ...
        }else if(action == 'get_inventory_report_hospital' || action == 'list_hospital_service_inventory_hospital' || action == 'add_product_quantity_hospital' || action == 'edit_product_quantity_hospital'){
