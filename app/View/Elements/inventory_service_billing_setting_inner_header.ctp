        ...
        <div class="row">
            <div class=" billing_element col-lg-12 col-md-12">
                ...
                <div class="hospital_service col-lg-12 col-md-12">
                    <a href="<?php echo Router::url('/app_admin/hospital_service_service',true); ?>" >
...
<script>
    $(function () {
        ...
        }else if(action == 'hospital_service_service' || action =="add_hospital_service_service" || action=="edit_hospital_service_service"){
        ...
        }else if(action == 'get_inventory_report_service' || action == 'list_hospital_service_inventory_service' || action == 'add_product_quantity_service' || action == 'edit_product_quantity_service'){
