(function($) {
    ...
    function fitLightbox() {
        ...
        $lightbox.each(function() {
            ...
            var $currentImg = $modalDialog.find('.carousel-item.active > img, .carousel-item.active > video');

            if ($modalDialog.find('.carousel-item.prev > img, .carousel-item.next > img').length) {
                $currentImg = $modalDialog.find('.carousel-item.prev > img, .carousel-item.prev > video, .carousel-item.next > img, .carousel-item.next > video').eq(0);
            }
    ...
    function pauseAllGalleryVideo(){
        $('.mbr-gallery video').each(function() {
            $(this).get(0).pause();
        });
    }
