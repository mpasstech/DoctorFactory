   ...
   'use strict'
            ...
            $("#map").gmap3({
                ...
                getlatlng:{
                    ...
                    callback: function(results) {
                        ...
                        $(this).gmap3({
                            marker:{
                                latLng:[26.857663, 75.824820],
                                options:{
                                    icon: 'https://mengage.in/doctor/home/images/icon/map.png'
                                }
                            }
                        });
                    }
    ...
    var retinaLogos = function() {
      var retina = window.devicePixelRatio > 1 ? true : false;
        ...
        if(retina) {
            $('.header .logo').find('img').attr({src:'/doctor/home/images/logo.png'});
            $('.footer-widgets .widget .textwidget').find('img').attr({src:'/doctor/home/images/logo.png'});
...
$(document).ready(function(){
	/* $('.menu-tab').bxSlider({
		mode: 'vertical', speed: 500, slideMargin:0, infiniteLoop: true, pager: false, controls: false,  minSlides: 3, maxSlides:4, moveSlides: 3
	}); */	
});