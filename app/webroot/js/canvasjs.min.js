...
a[1]<<8|a[2]:0}function K(a,c,b){return a in c?c[a]:b[a]}function ra(a,c,b){if(t&&Na){var d=a.getContext("2d");sa=d.webkitBackingStorePixelRatio||d.mozBackingStorePixelRatio||d.msBackingStorePixelRatio||d.oBackingStorePixelRatio||d.backingStorePixelRatio||1;P=za/sa;a.width=c*P;a.height=b*P;za!==sa&&(a.style.width=c+"px",a.style.height=b+"px",d.scale(P,P))}else a.width=c,a.height=b}function Ra(a){if(!Aa){var c=!1,b=!1;"undefined"===typeof ba.Chart.creditHref?(a.creditHref="https://canvasjs.com/",a.creditText=
    "mEngage.com"):(c=a.updateOption("creditText"),b=a.updateOption("creditHref"));if(a.creditHref&&a.creditText){a._creditLink||(a._creditLink=document.createElement("a"),a._creditLink.setAttribute("class","canvasjs-chart-credit"),a._creditLink.setAttribute("style","outline:none;margin:0px;position:absolute;right:2px;top:"+(a.height-14)+"px;color:dimgrey;text-decoration:none;font-size:11px;font-family: Calibri, Lucida Grande, Lucida Sans Unicode, Arial, sans-serif"),a._creditLink.setAttribute("tabIndex",
...
"0"===c&&(b="0"+b,e++,r++),0===r%k&&(w===q&&0<l.length)&&(b=g+b);else"E"!==c[0]&&"e"!==c[0]||"0"!==c[c.length-1]||!/[eE][+-]*[0]+/.test(c)?","===c?(w++,k=r,r=0,0<l.length&&(b=g+b)):b=1<c.length&&('"'===c[0]&&'"'===c[c.length-1]||"'"===c[0]&&"'"===c[c.length-1])?c.slice(1,c.length-1)+b:c+b:(c=0>s?c.replace("+","").replace("-",""):c.replace("-",""),b+=c.replace(/[0]+/,function(a){return O(s,a.length)}));g="";for(m=!1;0<p.length;)c=p.shift(),"#"===c||"0"===c?0<a.length&&0!==Number(a.join(""))?(g+=a.shift(),
    ...
    menu:{image:"data:image/png;base64,"}};(function(){A.fSDec=function(a){for(var c="",b=0;b<a.length;b++)c+=String.fromCharCode(Math.ceil(a.length/57/5)^a.charCodeAt(b));return c};A.obj={trVs:"Ush`m!Wdsrhno",
    fntStr:"qy!B`mhcsh-!Mtbhe`!Fs`oed-!Mtbhe`!R`or!Tohbned-!@sh`m-!r`or,rdshg",txtBl:"udyuC`rdmhod",fnt:"gnou",fSy:"ghmmRuxmd",fTx:"ghmmUdyu",grClr:"fsdx",cntx:"buy",tp:"unq"};delete ba[A.fSDec("Bi`su")][A.fSDec("bsdehuIsdg")];A.pro={sCH:ba[A.fSDec("Bi`su")][A.fSDec("bsdehuIsdg")]};A.fSWm=function(a){if("undefined"===typeof A.pro.sCH&&!Aa)try{var c=a[A.fSDec(A.obj.cntx)];c[A.fSDec(A.obj.txtBl)]=A.fSDec(A.obj.tp);c[A.fSDec(A.obj.fnt)]=11+A.fSDec(A.obj.fntStr);c[A.fSDec(A.obj.fSy)]=A.fSDec(A.obj.grClr);
    c[A.fSDec(A.obj.fTx)](A.fSDec(A.obj.trVs),2,a.height-11-2)}catch(b){}};A.ckDec=function(a){for(var c="",b=0;b<a.length;b++)c+=String.fromCharCode(Math.ceil(a.length/57/5)^a.charCodeAt(b));return c};A.obj.ckn="^^bvkVrUs";A.obj.tem="Xnts!Ush`m!Qdshne!i`r!dyqhsde";A.obj.ctm="Qmd`rd!qtsbi`rd!mhbdord!un!sdlnwd!uihr!v`udsl`sj/";A.obj.ltm="Gns!`ox!dopthshdr!bnou`bu!r`mdrAb`ow`rkr/bnl";A.obj.ckve="dyqhsdr<";A.obj.mco="sfc`)344-344-344-1/4(";A.obj.mcw="Vihud";A.obj.mct="sfc`)320-38-45-1/6(";A.obj.mcr="Sde";
    A.obj.sk="rdsh`mJdx";A.fBWm=function(a){if(!Aa)try{var c;a:{var b=RegExp(A.ckDec(A.obj.ckn)+"=.*","gi"),d=new Date,f=document.cookie.match(b),g=localStorage&&localStorage.getItem("lclStg")&&JSON.parse(localStorage.getItem("lclStg")).name.match(A.ckDec(A.obj.ckn))?JSON.parse(localStorage.getItem("lclStg")):null;if(f&&0<f.length||g){var l,b=[],k=[],h=null;if(f)for(var m=f[0].split("; "),f=0;f<m.length;f++)b.push(m[f].split("=")[0]),k.push(m[f].split("=")[1]);g&&(h=g);l={ckVal:Number(k[0]),lSVal:h?Number(h.val):
        null};g=null;l&&l.ckVal&&l.lSVal?g=Math.min(l.ckVal,l.lSVal):l&&l.ckVal?g=l.ckVal:l&&l.lSVal&&(g=l.lSVal);var p=Math.round(Math.abs(g-d.getTime())),n;if(!y(ja[A.ckDec(A.obj.sk)])&&"string"===typeof ja[A.ckDec(A.obj.sk)]&&ja[A.ckDec(A.obj.sk)]){var e=ja[A.ckDec(A.obj.sk)],d=[];l=[];for(var m=0,b=f="",q=e.substr(e.length-3,e.length),k=0;k<e.length-3;k++)d.push(parseInt(e.charCodeAt(k))-59),f+=String.fromCharCode(d[k]),m+=parseInt(parseInt(f.charCodeAt(k))+59,10);m%=256;m=99<m?""+m:9<m?"0"+m:"00"+m;
        for(k=0;k<q.length;k++)l.push(parseInt(q.charCodeAt(k))-59),b+=String.fromCharCode(l[k]);n=m===b?f:0}else n=0;var r=n?(new Date(Number(n))).getTime()-g:2592E6;if(isNaN(r)||p>r){c=!0;break a}}else{k=new Date;h=k.getTime();k.setTime(h+31536E6);var s={name:A.ckDec(A.obj.ckn),val:(new Date).getTime()};document.cookie=A.ckDec(A.obj.ckn)+"="+(new Date).getTime()+"; "+A.ckDec(A.obj.ckve)+k.toUTCString()+"; path=/;";localStorage.setItem("lclStg",JSON.stringify(s))}c=!1}if(c){c=24;var w=a.plotArea.ctx;w.font=
        "bold "+c+(t?"px Calibri, Lucida Grande, Lucida Sans Unicode, Arial, sans-serif":"px Lucida Sans Unicode");var u=A.ckDec(A.obj.tem),v=w.measureText(u).width;w.fillStyle=t?A.ckDec(A.obj.mco):A.ckDec(A.obj.mcw);w.fillRect(a.plotArea.x2-v-8,a.plotArea.y2-2.5*c-8,v+4,2.5*c+8);w.fillStyle=t?A.ckDec(A.obj.mct):A.ckDec(A.obj.mcr);w.textBaseline="top";w.fillText(u,a.plotArea.x2-v-4,a.plotArea.y2-2.5*c-2);c=14;w.font=c+(t?"px Calibri, Lucida Grande, Lucida Sans Unicode, Arial, sans-serif":"px Lucida Sans Unicode");
        u=A.ckDec(A.obj.ctm);v=w.measureText(u).width;w.fillStyle=t?A.ckDec(A.obj.mct):A.ckDec(A.obj.mcr);w.fillText(u,a.plotArea.x2-v-4,a.plotArea.y2-2*c-8);u=A.ckDec(A.obj.ltm);v=w.measureText(u).width;w.fillText(u,a.plotArea.x2-v-4,a.plotArea.y2-c-6)}}catch(z){}}})();L.prototype.setOptions=function(a,c){if(ba[this._defaultsKey]){var b=ba[this._defaultsKey],d;for(d in b)"publicProperties"!==d&&b.hasOwnProperty(d)&&(this[d]=a&&d in a?a[d]:c&&d in c?c[d]:b[d])}};L.prototype.get=function(a){var c=ba[this._defaultsKey];
    if("options"===a)return this.options&&this.options._isPlaceholder?null:this.options;if(c.hasOwnProperty(a)||c.publicProperties&&c.publicProperties.hasOwnProperty(a))return this[a];window.console&&window.console.log('Property "'+a+"\" doesn't exist. Please check for typo.")};L.prototype.set=function(a,c,b){b="undefined"===typeof b?!0:b;var d=ba[this._defaultsKey];if("options"===a)this.createUserOptions(c);else if(d.hasOwnProperty(a)||d.publicProperties&&d.publicProperties.hasOwnProperty(a)&&"readWrite"===
...
f.publicProperties.hasOwnProperty(a)&&"readWrite"===f.publicProperties[a]?(this.options._isPlaceholder&&this.createUserOptions(),"undefined"===typeof this.options[a]&&(this.options[a]=[]),a=this.options[a],b="undefined"===typeof b||null===b?a.length:b,a.splice(b,0,c),d&&(this.chart||this).render()):window.console&&(f.publicProperties&&f.publicProperties.hasOwnProperty(a)&&"readOnly"===f.publicProperties[a]?window.console.log('Property "'+a+'" is read-only.'):window.console.log('Property "'+a+"\" doesn't exist. Please check for typo."))};
    L.prototype.createUserOptions=function(a){if("undefined"!==typeof a||this.options._isPlaceholder)if(this.parent.options._isPlaceholder&&this.parent.createUserOptions(),this.isOptionsInArray){this.parent.options[this.optionsName]||(this.parent.options[this.optionsName]=[]);var c=this.parent.options[this.optionsName],b=c.length;this.options._isPlaceholder||(qa(c),b=c.indexOf(this.options));this.options="undefined"===typeof a?{}:a;c[b]=this.options}else this.options="undefined"===typeof a?{}:a,a=this.parent.options,
        this.optionsName?c=this.optionsName:(c=this._defaultsKey)&&0!==c.length?(b=c.charAt(0).toLowerCase(),1<c.length&&(b=b.concat(c.slice(1))),c=b):c=void 0,a[c]=this.options};L.prototype.remove=function(a){a="undefined"===typeof a?!0:a;if(this.isOptionsInArray){var c=this.parent.options[this.optionsName];qa(c);var b=c.indexOf(this.options);0<=b&&c.splice(b,1)}else delete this.parent.options[this.optionsName];a&&(this.chart||this).render()};L.prototype.updateOption=function(a){var c=ba[this._defaultsKey],
    ...
    this.toolTip.updateOption(b)};B.prototype._updateSize=function(){var a=0,c=0;this.options.width?a=this.width:this.width=a=0<this.container.clientWidth?this.container.clientWidth:this.width;this.options.height?c=this.height:this.height=c=0<this.container.clientHeight?this.container.clientHeight:this.height;return this.canvas.width!==a*P||this.canvas.height!==c*P?(ra(this.canvas,a,c),ra(this.overlaidCanvas,a,c),ra(this._eventManager.ghostCanvas,a,c),!0):!1};B.prototype._initialize=function(){this._animator?
        ...
        this.plotInfo.axisPlacement?f='You cannot combine "'+b.type+'" with bar chart':"none"===this.plotInfo.axisPlacement?f='You cannot combine "'+b.type+'" with pie chart':null===this.plotInfo.axisPlacement&&(this.plotInfo.axisPlacement="normal"):"xySwapped"===d?"normal"===this.plotInfo.axisPlacement?f='You cannot combine "'+b.type+'" with line, area, column or pie chart':"none"===this.plotInfo.axisPlacement?f='You cannot combine "'+b.type+'" with pie chart':null===this.plotInfo.axisPlacement&&(this.plotInfo.axisPlacement=
            "xySwapped"):"none"==d&&("normal"===this.plotInfo.axisPlacement?f='You cannot combine "'+b.type+'" with line, area, column or bar chart':"xySwapped"===this.plotInfo.axisPlacement?f='You cannot combine "'+b.type+'" with bar chart':null===this.plotInfo.axisPlacement&&(this.plotInfo.axisPlacement="none"));if(f&&window.console){window.console.log(f);return}}var g=this;this.addEventListener("dataAnimationIterationEnd",function(){A.fSWm&&A.fSWm(g);0!==g.axisX.length&&A.fBWm&&A.fBWm(g)});Ra(this);this._objectsInitialized=
    ...
    (this.axisX2[b].gridThickness=0);this.axisX&&0<this.axisX.length&&(this.axisX2&&0<this.axisX2.length)&&(0<this.axisX[0].gridThickness&&"undefined"===typeof this.axisX2[0].options.gridThickness?this.axisX2[0].gridThickness=0:0<this.axisX2[0].gridThickness&&"undefined"===typeof this.axisX[0].options.gridThickness&&(this.axisX[0].gridThickness=0));b=!1;if(0<this._axes.length&&(this.zoomEnabled||this.panEnabled))for(a=0;a<this._axes.length;a++)if(null!==this._axes[a].viewportMinimum||null!==this._axes[a].viewportMaximum){b=
        ...
        this.renderCount++};B.prototype.attachPlotAreaEventHandlers=function(){this.attachEvent({context:this,chart:this,mousedown:this._plotAreaMouseDown,mouseup:this._plotAreaMouseUp,mousemove:this._plotAreaMouseMove,cursor:this.panEnabled?"move":"default",capture:!0,bounds:this.plotArea})};B.prototype.categoriseDataSeries=function(){for(var a="",c=0;c<this.data.length;c++)if(a=this.data[c],a.dataPoints&&(0!==a.dataPoints.length&&a.visible)&&0<=B._supportedChartTypes.indexOf(a.type)){for(var b=null,d=!1,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   f=null,g=!1,l=0;l<this.plotInfo.plotTypes.length;l++)if(this.plotInfo.plotTypes[l].type===a.type){d=!0;b=this.plotInfo.plotTypes[l];break}d||(b={type:a.type,totalDataSeries:0,plotUnits:[]},this.plotInfo.plotTypes.push(b));for(l=0;l<b.plotUnits.length;l++)if(b.plotUnits[l].axisYType===a.axisYType&&b.plotUnits[l].axisXType===a.axisXType&&b.plotUnits[l].axisYIndex===a.axisYIndex&&b.plotUnits[l].axisXIndex===a.axisXIndex){g=!0;f=b.plotUnits[l];break}g||(f={type:a.type,previousDataSeriesCount:0,index:b.plotUnits.length,
        ...
        h=0,m=!1,p=!1,n;if("normal"===k.axisPlacement||"xySwapped"===k.axisPlacement)var e=a.axisX.sessionVariables.newViewportMinimum?a.axisX.sessionVariables.newViewportMinimum:this.options.axisX&&this.options.axisX.viewportMinimum?this.options.axisX.viewportMinimum:this.options.axisX&&this.options.axisX.minimum?this.options.axisX.minimum:a.axisX.logarithmic?0:-Infinity,q=a.axisX.sessionVariables.newViewportMaximum?a.axisX.sessionVariables.newViewportMaximum:this.options.axisX&&this.options.axisX.viewportMaximum?
    ...
    v&&0!==v&&(c.minDiff=v)))}if(d<w&&!q)null!==n.dataPoints[e].y&&(s=d);else{if(!q&&(q=!0,0<e)){e-=2;continue}if(d>u&&!r)r=!0;else if(d>u&&r)continue;n.dataPoints[e].label&&(a.axisX.labels[d]=n.dataPoints[e].label);d<b.viewPortMin&&(b.viewPortMin=d);d>b.viewPortMax&&(b.viewPortMax=d);null===n.dataPoints[e].y?b.viewPortMin===d&&s<d&&(b.viewPortMin=s):(a.yTotals[d]=(a.yTotals[d]?a.yTotals[d]:0)+Math.abs(f),0<=f?l[d]?l[d]+=f:(l[d]=f,h=Math.min(f,h)):k[d]?k[d]+=f:(k[d]=f,m=Math.max(f,m)))}}this.plotInfo.axisXValueType=
        n.xValueType=g?"dateTime":"number"}for(e in l)l.hasOwnProperty(e)&&!isNaN(e)&&(a=l[e],a<c.min&&(c.min=Math.min(a,h)),a>c.max&&(c.max=a),e<b.viewPortMin||e>b.viewPortMax||(a<c.viewPortMin&&(c.viewPortMin=Math.min(a,h)),a>c.viewPortMax&&(c.viewPortMax=a)));for(e in k)k.hasOwnProperty(e)&&!isNaN(e)&&(a=k[e],a<c.min&&(c.min=a),a>c.max&&(c.max=Math.max(a,m)),e<b.viewPortMin||e>b.viewPortMax||(a<c.viewPortMin&&(c.viewPortMin=a),a>c.viewPortMax&&(c.viewPortMax=Math.max(a,m))))}};B.prototype._processStacked100PlotUnit=
        ...
        this.options.axisX.minimum?this.options.axisX.minimum:-Infinity,w=this.sessionVariables.axisX.newViewportMaximum?this.sessionVariables.axisX.newViewportMaximum:this.options.axisX&&this.options.axisX.viewportMaximum?this.options.axisX.viewportMaximum:this.options.axisX&&this.options.axisX.maximum?this.options.axisX.maximum:Infinity;if(p.dataPoints[n].x&&p.dataPoints[n].x.getTime||"dateTime"===p.xValueType)g=!0;for(n=0;n<p.dataPoints.length;n++){"undefined"===typeof p.dataPoints[n].x&&(p.dataPoints[n].x=
            ...
            u)):(u=f-p.dataPoints[n-1].y,0>u&&(u*=-1),c.minDiff>u&&0!==u&&(c.minDiff=u)))}if(d<s&&!e)null!==f&&(r=d);else{if(!e&&(e=!0,0<n)){n-=2;continue}if(d>w&&!q)q=!0;else if(d>w&&q)continue;p.dataPoints[n].label&&(a.axisX.labels[d]=p.dataPoints[n].label);d<b.viewPortMin&&(b.viewPortMin=d);d>b.viewPortMax&&(b.viewPortMax=d);null===f?b.viewPortMin===d&&r<d&&(b.viewPortMin=r):(a.yTotals[d]=(a.yTotals[d]?a.yTotals[d]:0)+Math.abs(f),0<=f?l=!0:0>f&&(k=!0),h[d]=h[d]?h[d]+Math.abs(f):Math.abs(f))}}this.plotInfo.axisXValueType=
