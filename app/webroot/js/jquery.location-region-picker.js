...
;(function ( $, window, document, undefined ) {
	...
	LocationRegionPicker.prototype.newLocationSelected = function() {
		...
		$(".content_div .palace_id").val(this.place.place_id);
      //  $(".content_div .latitude").val(this.place.geometry.location.lat());
      //  $(".content_div .longitude").val(this.place.geometry.location.lng());
