<?php
    $data = array(
            'step_1'=>array(
                    ...
                    'subtitle'=>"<p>Stop and call 911 if you are experiencing:</p><ul><li>Severe, constant chest pain or pressure</li><li>Extreme difficulty breathing</li><li>Severe, constant lightheadedness</li><li>Serious disorientation or unresponsiveness</li></ul>",
                    'option'=>array(
        ...
        <div class="container">
            <form id="form">
                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 display_content" id="step_0">
                    ...
                    <p ><button type="button" class="btn btn-info action_btn" data-next="step_1">Next</button></p>
                </div>
                <?php foreach ($data as $step_id => $content){ ?>
