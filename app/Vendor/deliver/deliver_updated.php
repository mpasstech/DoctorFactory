...
class Deliver
{
	...
	public function send_message($mobile = null, $messge = null,$is_transactional = null, $mask = null, $user_default_sms_api = null)
	{
		...
		if($default_api == 'GUPSHUP'){
			...
			if($is_transactional == 'N'){
				...
				$url .= "&msg=" . $messge;
				$url .= "&msg_type=Unicode_text&userid=" . GUPSHUP_PROMOTIONAL_API_USER_ID  . "&auth_scheme=plain&password=" . GUPSHUP_PROMOTIONAL_API_USER_PASSWORD  . "&v=1.1&format=json";
			}else{
		...
		if($default_api == 'ROUTE'){
			...
			return json_encode(array('response'=>$resp),true); die;
		}
	...
	public function send_message_android($device_id = null, $message = null,$channel_name = null,$channel_id = null,$channel_image = null,$is_mute = null,$type = null,$mq_id = null,$thumb_url = null,$image = null,$is_response = null,$subscriber_id = null)
	{
		$url = 'https://android.googleapis.com/gcm/send';
		
		$data='{"data":{"message":"'.$message.'", "channel_name":"'.$channel_name.'", "channel_id":"'.$channel_id.'", "channel_image":"'.$channel_image.'", "is_mute":"'.$is_mute.'", "mq_id":"'.$mq_id.'", "thumb":"'.$thumb_url.'", "image":"'.$image.'", "is_response":"'.$is_response.'","subscriber_id":"'.$subscriber_id.'", "msg_type":"MESSAGE"}}';
	...
	public function push_notification($deviceToken = null, $message = null,$channel_name = null,$channel_id = null,$channel_image = null,$is_mute = null,$type = null,$mq_id = null,$thumb_url = null,$image = null,$is_response = null,$subscriber_id = null)
	{
		//echo $is_mute;
	...
	//$deviceToken = '8cbc97f89a131e8f096a500ccdce5bc14041e17eadbfd9a9c56620f2fd332a2b'; // Put your device token here (without spaces):
		...
		if($is_mute == '0'){
			$body['aps'] = array('alert' => $message,'sound'=>'default','badge' => 1,'channel_id' => $channel_id,'channel_name' => $channel_name,'channel_image' => $channel_image,'is_mute' => $is_mute,'type' => $type,'mq_id' => $mq_id,'thumb'=>$thumb_url,'image'=>$image,'is_response'=>$is_response,'subscriber_id'=>$subscriber_id,'msg_type' => 'MESSAGE');
			
		}else{
		  	$body['aps'] = array('alert' => $message,'badge' => 1,'channel_id' => $channel_id,'channel_name' => $channel_name,'channel_image' => $channel_image,'is_mute' => $is_mute,'type' => $type,'mq_id' => $mq_id,'thumb'=>$thumb_url,'image'=>$image,'is_response'=>$is_response,'subscriber_id'=>$subscriber_id,'msg_type' => 'MESSAGE');
	...
	public function push_android($device_id = null, $message = null,$channel_name = null,$channel_id = null,$channel_image = null,$status = null)
	{
		...
		$data='{"data":{"message":"'.$message.'", "channel_name":"'.$channel_name.'", "channel_id":"'.$channel_id.'", "channel_image":"'.$channel_image.'", "status":"'.$status.'", "msg_type":"'.$msg_type.'"}}';
		$fields = array(
		    'registration_ids' => array($device_id),
		    'data' => $data);
		$headers = array(
	...
	public function push_ios($deviceToken = null, $passphrase = null, $message = null,$channel_name = null,$channel_id = null,$channel_image = null,$status = null)
	{
		//echo $is_mute;
