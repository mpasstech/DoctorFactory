...
class Deliver
{
	...
	public function send_message_android($device_id = null, $message = null,$channel_name = null,$channel_id = null,$channel_image = null,$is_mute = null,$type = null,$mq_id = null,$thumb_url = null,$image = null,$is_response = null,$subscriber_id = null)
	{
		...
		//$data='{"data":{"message":"'.$message.'", "channel_name":"'.$channel_name.'", "channel_id":"'.$channel_id.'", "channel_image":"'.$channel_image.'", "is_mute":"'.$is_mute.'", "mq_id":"'.$mq_id.'", "thumb":"'.$thumb_url.'", "image":"'.$image.'", "is_response":"'.$is_response.'","subscriber_id":"'.$subscriber_id.'"}}';
